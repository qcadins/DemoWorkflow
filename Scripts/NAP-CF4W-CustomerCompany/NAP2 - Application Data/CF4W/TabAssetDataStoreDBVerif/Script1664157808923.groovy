...
if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 41).equalsIgnoreCase('No')) {
    ...
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 42).equalsIgnoreCase('Company')) {
	...
	if(findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 50).length() > 0){
