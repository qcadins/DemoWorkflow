...
if (CustomKeywords.'assetData.checkAssetData.checkSelfUsage'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Usage Checkbox Input CF4W'), GlobalVariable.NumofColm, excelPathTabAsset) == true) {
...
if (CustomKeywords.'assetData.checkAssetData.checkSelfOwner'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Owner CheckBox Input CF4W'), GlobalVariable.NumofColm, excelPathTabAsset) == true) {
