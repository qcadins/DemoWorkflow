...
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Supplier Name_CF4W'))
...
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Asset Name_CF4W'))
...
'input asset price'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Asset Price_CF4W'), 
...
if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 22).length() > 0) {
    ...
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_BPKB City Issuer_CF4W'))
...
'input notes'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/textarea_NotesCF4W'), findTestData(excelPathTabAsset).getValue(
...
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-CF4W'))

if(GlobalVariable.RoleCompany=="Testing" && GlobalVariable.CheckRuleCompany == "Yes"){
	'verify dp percentage default sesuai rule'
	WebUI.verifyEqual(Double.parseDouble(resultDP.get(0)),Double.parseDouble(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-CF4W'),'value').replace(" %","")))
	...
	if(resultDP.get(1)=="DEF" && findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 26) == 'Percentage'){
		...
		WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-CF4W'),'readonly',GlobalVariable.TimeOut)
	}
		...
		WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-CF4W'),'readonly',GlobalVariable.TimeOut)
	}
	else if(resultDP.get(1)=="LOCK"){
		'verify dp percentage terlock'
		WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-CF4W'),'readonly',GlobalVariable.TimeOut)
		
		'verify dp amount terlock'
		WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-CF4W'),'readonly',GlobalVariable.TimeOut)
	}
}
...
if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 26) == 'Percentage') {
    ...
    WebUI.sendKeys(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-CF4W'), 
    ...
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-CF4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 28))
}

'input chasis number'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_CHASIS NUMBER_CF4W'), findTestData(excelPathTabAsset).getValue(
        GlobalVariable.NumofColm, 29))

'input engine number'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_ENGINE NUMBER-CF4W'), findTestData(excelPathTabAsset).getValue(
        GlobalVariable.NumofColm, 30))

if (GlobalVariable.RoleCompany == 'Testing') {
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 26) == 'Percentage') {
        'get attribute dp amount dari confins'
        DownPaymentAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-CF4W'), 
            'value')
        ...
        DownPaymentPrctg = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-CF4W'), 
            'value').replace(' %', '')
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_LICENSE PLATE NUMBER_CF4W'), findTestData(excelPathTabAsset).getValue(
...
WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/NAP2 - Application Data/CF4W/TabAccessoriesAsset'), [:], FailureHandling.CONTINUE_ON_FAILURE)

if (CustomKeywords.'assetData.checkAssetData.checkSelfUsage'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Usage Checkbox Input CF4W'), GlobalVariable.NumofColm, 37, excelPathTabAsset) == true) {
    'click self usage check box'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Usage Checkbox CF4W'))
} else if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 37) == 'No') {
    if (WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/status selfusage checkbox_CF4W'), 
        'aria-checked') == 'true') {
        'click self usage check box'
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Usage Checkbox CF4W'))
    }
    ...
    'input user name'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_User Name_CF4W'), 
    ...
    if (GlobalVariable.RoleCompany == 'Testing') {
        ...
        if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship-CF4W'), 
            userRelation) == false) {
        ...
        Integer totalUserRelation = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship-CF4W'))
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship-CF4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 39), false)
}

if (CustomKeywords.'assetData.checkAssetData.checkSelfOwner'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Owner CheckBox Input CF4W'), GlobalVariable.NumofColm, 41, excelPathTabAsset) == true) {
    'click self owner checkbox'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Owner CheckBox CF4W'))
    ...
    if (WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/status self owner checkbox_CF4W'), 
        'aria-checked') == 'true') {
        'click self owner checkbox'
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Owner CheckBox CF4W'))
    }
    ...
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 42) == 'Personal') {
        ...
        if (GlobalVariable.RoleCompany == 'Testing') {
			...
			int totalddlownerprofession = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Company Owner Profession-CF4W'))
			...
			if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Company Owner Profession-CF4W'),
    ...
    'input owner name'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Name_CF4W'), 
    ...
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 42) == 'Personal') {
        if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 46).length() > 1) {
            ...
            WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Owner Profession_CF4W'))
	    ...
	    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Company Owner Profession-CF4W'), 
	...
	if(GlobalVariable.RoleCompany == 'Testing'){
		...
		int totalddlcopyaddrassetowner = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Asset Owner Copy Address_CF4W'))
		...
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Asset Owner Copy Address_CF4W'),
				copyaddr) == false) {
    ...
    'input id no'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Id No_CF4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofColm, 49))

    'input owner mobile no'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Mobile Phone No_CF4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 50))

    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 52) == 'Yes') {
        'select copy address'
        WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Asset Owner Copy Address_CF4W'), 
            findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 53), false)

        'click button copy'
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Copy - CF4W'))
...
if (GlobalVariable.FlagFailed == 0) {
    ...
    CustomKeywords.'checkSaveProcess.checkSaveProcess.checkStatus'(iscompleteMandatory, findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/select_InsuredBy'), 
...
if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Supplier Name_CF4W'), 
    ...
    if ((GlobalVariable.RoleCompany == 'Testing') && (GlobalVariable.CheckVerifStoreDBCompany == 'Yes')) {
    	if(findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/Accessories').getValue(GlobalVariable.NumofAccessories, 1) == 'SUCCESS'){
    		...
    		WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/NAP2 - Application Data/CF4W/TabAccessoriesDataStoreDBVerif'), 
    				[:], FailureHandling.CONTINUE_ON_FAILURE)
    	}
    	
    	'call test case store db asset data'
    	WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/NAP2 - Application Data/CF4W/TabAssetDataStoreDBVerif'), [:], FailureHandling.CONTINUE_ON_FAILURE)
    }
}
...
def assetLocInput() {
    'input address'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_AddressText-CF4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 54))

    'input RT'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_InputRT-CF4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofColm, 55))

    'input RW'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_InputRW-CF4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofColm, 56))

    'click button zipcode'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_ButtonZipcode-CF4W'))
...
def assetLocCopy() {
    ...
    'click button copy'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_ButtonCopy-CF4W'))
}
...
def getDataOwner() {
	...
	if(findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 41) == 'Yes'){
		...
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Name_CF4W'),
				'value'))
		...
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Id No_CF4W'),
				'value'))
		
		'add owner owner mobile no to array'
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Mobile Phone No_CF4W'),
				'value'))
	}
	...
	if(findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofColm, 41) == 'No'){
		...
		modifyObjectAssetOwnerZipcode = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/labelZipcodeAssetOwnerCF4W'),
		...
		'add zipcode to array'
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/labelZipcodeAssetOwnerCF4W'), 'value'))
	}
