...
String custname = WebUI.getText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/labelCustomerName-CF4W'))

ArrayList<String> result = CustomKeywords.'dbConnection.CustomerDataVerif.NAP2TabApplicationStoreDBCF4W'(sqlconnection, findTestData(excelPathCustomerCompany).getValue(
