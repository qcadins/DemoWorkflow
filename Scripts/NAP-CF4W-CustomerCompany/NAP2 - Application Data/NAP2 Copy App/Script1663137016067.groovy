...
'copy app insurance data'
if (findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData').getValue(GlobalVariable.NumofColm, 10).equalsIgnoreCase(
    'No')) {
...
'copy app financial data'
if (findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData').getValue(GlobalVariable.NumofColm, 10).equalsIgnoreCase(
    'No')) {
...
'copy app upload document'
if (findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabUploadDocument').getValue(GlobalVariable.NumofColm, 10).equalsIgnoreCase(
    'No')) {
