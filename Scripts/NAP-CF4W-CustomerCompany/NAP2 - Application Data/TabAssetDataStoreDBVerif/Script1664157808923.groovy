...
ArrayList<String> resultsupplierinformation = CustomKeywords.'dbConnection.CustomerDataVerif.NAP2TabAssetSupplierInfoStoreDB'(sqlconnectionLOS, datafileCustomerCompany.getValue(
	GlobalVariable.NumofColm, 13))
	
ArrayList<String> resultassetinformation = CustomKeywords.'dbConnection.CustomerDataVerif.NAP2TabAssetStoreDB'(sqlconnectionLOS, datafileCustomerCompany.getValue(
        GlobalVariable.NumofColm, 13))
