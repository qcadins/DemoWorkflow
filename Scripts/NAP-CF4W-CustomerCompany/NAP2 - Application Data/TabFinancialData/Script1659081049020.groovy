...
if(GlobalVariable.RoleCompany=="Testing"){
	...
	if(varsize==SubsidyFromType.size() && varsize > 0){
		...
		for (i = 1; i <= varsize; i++) {
			...
			modifyNewSubsidyAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/td_SubsidyAmount'),'xpath','equals',"//*[@id='FinData_Subsidy']/div[2]/table/tbody/tr["+i+"]/td[7]",true)
...
if(GlobalVariable.RoleCompany=="Testing"){
	...
	for(int i = counter;i<listFee.size();i++){
		...
		if(CustomKeywords.'financialData.verifFee.checkFeeCode'(sqlConnectionLOS,WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/label_Fee')))==listFee.get(i)){
			'Verify amount admin fee pada confins sesuai rule'
			WebUI.verifyMatch(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Admin Fee'),'value').replace(",",""),fee.get(i),false)
			if(feeBhv.get(i)=="DEF"){
				'Verify admin fee tidak terlock'
				WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Admin Fee'),'readonly',1)
			}
			else if(feeBhv.get(i)=="LOCK"){
				'verify admin fee terlock'
				WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Admin Fee'),'readonly',1)
			}
			if(feecapType.get(i)=="AMT"){
				'Verify admin fee capitalized amount sesuai rule'
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Admin Fee Capitalize_'),'value').replace(",",""),feecap.get(i),false,FailureHandling.OPTIONAL)
			}
		}
		'Pengecekan jika list fee pada rule sesuai dengan fee pada confins'
		if(CustomKeywords.'financialData.verifFee.checkFeeCode'(sqlConnectionLOS,WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/label_Fee2')))==listFee.get(i)){
			'Verify amount additional admin pada confins sesuai rule'
			WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Additional Admin'),'value').replace(",",""),fee.get(i),false)
			if(feeBhv.get(i)=="DEF"){
				'verify additional admin tidak terlock'
				WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Additional Admin'),'readonly',1)
			}
			else if(feeBhv.get(i)=="LOCK"){
				'verify additional admin terlock'
				WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Additional Admin'),'readonly',1)
			}
			if(feecapType.get(i)=="AMT"){
				'Verify additional admin capitalized amount sesuai rule'
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Additional Admin Capitalize'),'value').replace(",",""),feecap.get(i),false,FailureHandling.OPTIONAL)
			}
		}
		'Pengecekan jika list fee pada rule sesuai dengan fee pada confins'
		if(CustomKeywords.'financialData.verifFee.checkFeeCode'(sqlConnectionLOS,WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/label_Fee3')))==listFee.get(i)){
			'Verify notary fee pada confins sesuai rule'
			WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Notary Fee'),'value').replace(",",""),fee.get(i),false)
			if(feeBhv.get(i)=="DEF"){
				'Verify notary fee tidak terlock'
				WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Notary Fee'),'readonly',1)
			}
			else if(feeBhv.get(i)=="LOCK"){
				'Verify notary fee terlock'
				WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Notary Fee'),'readonly',1)
			}
			if(feecapType.get(i)=="AMT"){
				'Verify notary fee capitalized amount sesuai rule'
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Notary Fee Capitalize'),'value').replace(",",""),feecap.get(i),false,FailureHandling.OPTIONAL)
			}
		}
		'Pengecekan jika list fee pada rule sesuai dengan fee pada confins'
		if(CustomKeywords.'financialData.verifFee.checkFeeCode'(sqlConnectionLOS,WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/label_Fee4')))==listFee.get(i)){
			'Verify other fee pada confins sesuai rule'
			WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Other Fee'),'value').replace(",",""),fee.get(i),false)
			if(feeBhv.get(i)=="DEF"){
				'verify other fee tidak terlock'
				WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Other Fee'),'readonly',1)
			}
			else if(feeBhv.get(i)=="LOCK"){
				'verify other fee terlock'
				WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Other Fee'),'readonly',1)
			}
			if(feecapType.get(i)=="AMT"){
				'Verify other fee capitalized amount sesuai rule'
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Other Fee Capitalize'),'value').replace(",",""),feecap.get(i),false,FailureHandling.OPTIONAL)
			}
		}
		'Pengecekan jika list fee pada rule sesuai dengan fee pada confins'
		if(CustomKeywords.'financialData.verifFee.checkFeeCode'(sqlConnectionLOS,WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/label_Fee5')))==listFee.get(i)){
			'verify fiducia fee pada confins sesuai rule'
			WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Fiducia Fee'),'value').replace(",",""),fee.get(i),false)
			if(feeBhv.get(i)=="DEF"){
				'Verify fiducia fee tidak terlock'
				WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Fiducia Fee'),'readonly',1)
			}
			else if(feeBhv.get(i)=="LOCK"){
				'Verify fiducia fee terlock'
				WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Fiducia Fee'),'readonly',1)
			}
			if(feecapType.get(i)=="AMT"){
				'Verify fiducia fee capitalized amount sesuai rule'
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Fiducia Fee Capitalize'),'value').replace(",",""),feecap.get(i),false,FailureHandling.OPTIONAL)
			}
		}
		...
		if(listFee.get(i)=="PROVISION"){
			...
			if(feeType.get(i)=="AMT"){
				...
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Amount'),'value').replace(",",""),fee.get(i),false)
				if(feeBhv.get(i)=="DEF"){
					'Verify provision fee amount tidak terlock'
					WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Amount'),'readonly',1)
				}
				else if(feeBhv.get(i)=="LOCK"){
					//Verify provision fee amt & pctg terlock
					WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Amount'),'readonly',1)
					WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Percentage'),'readonly',1)
				}
			}
			else if(feeType.get(i)=="PRCNT"){
				'Verify provision fee pada confins sesuai rule'
				WebUI.verifyEqual(Double.parseDouble(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Percentage'),'value').replace(" %","")),Double.parseDouble(fee.get(i)))
				if(feeBhv.get(i)=="DEF"){
					'verify provision fee percentage tidak terlock'
					WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Percentage'),'readonly',1)
				}
				else if(feeBhv.get(i)=="LOCK"){
					//Verify provision fee amt & pctg terlock
					WebUI.verifyElementHasAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Amount'),'readonly',1)
			...
			if(feecapType.get(i)=="AMT"){
				...
				WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Capitalize'),'value').replace(",",""),feecap.get(i),false,FailureHandling.OPTIONAL)
			}
