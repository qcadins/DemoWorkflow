...
'input supplier code'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_SupplierCode'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 12))
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 15).length() > 
0) {
    'select admin head'
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_AdminHead'), 
        datafileTabAsset.getValue(GlobalVariable.NumofColm, 15), 
        false)
}
...
'input asset name'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_FullAssetCode'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 17))
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 22).length() > 
0) {
    ...
    'input district code'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_District Code'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 22))
    ...
    if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/a_Select'), 
        ...
        if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 
            20) == 'New') {
            flagWarning++
        }
    }
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_BPKB Issue Date'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 23))

'input notes'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/textarea_Notes'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 24))

'input manufacturing year'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Manufacturing Year'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 25))
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 26) == 
'Percentage') {
    ...
    WebUI.sendKeys(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)_downPaymentPrctg'), 
        Keys.chord(Keys.RIGHT, datafileTabAsset.getValue(GlobalVariable.NumofColm, 
                27)))
} else if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 
    26) == 'Amount') {
...
'input chasis number'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_CHASIS NUMBER'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 29))

'input engine number'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_ENGINE NUMBER'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 30))
...
if (GlobalVariable.RoleCompany == 'Testing') {
    ...
    if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 24) == 
    'Percentage') {
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_LICENSE PLATE NUMBER'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 31))

if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial4'), 
    5, FailureHandling.OPTIONAL)) {
    'input serial 4'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial4'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 32), FailureHandling.OPTIONAL)
}

if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial5'), 
    5, FailureHandling.OPTIONAL)) {
    'input serial 5'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial5'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 33), FailureHandling.OPTIONAL)
}

if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 18) == 
'Used') {
    if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 62) == 
    'Yes') {
...
String Fullassetcode = datafileTabAsset.getValue(GlobalVariable.NumofColm, 
    17)

'count asset attribute'
String countAssetAtrtibute = CustomKeywords.'customizeKeyword.getRowAssetAttribute.countRowAssetAttribute'(sqlconnectionFOU, sqlconnectionLOS,
...
if (WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/status selfusage checkbox'),
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship'), 
        datafileTabAsset.getValue(GlobalVariable.NumofColm, 39), 
        false)
}
...
if (WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/status self owner checkbox'),
    ...
    if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 42) == 
    'Personal') {
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Owner Relationship'), 
        datafileTabAsset.getValue(GlobalVariable.NumofColm, 44), 
        false)
    ...
    'Personal') {
        if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 
            ...
            WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Profession Code_professionCodeId'), 
                datafileTabAsset.getValue(GlobalVariable.NumofColm, 
                    45))
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_-ID Type'), 
        datafileTabAsset.getValue(GlobalVariable.NumofColm, 48), 
        false)

    'input id no'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Id No'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 49))
    ...
    if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 52) == 
    'Yes') {
        'select copy address'
        ...
        'input RT'
        WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_RT'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 55))

        'input RW'
        WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_RW'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 56))
...
'Yes') {
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation _ Copy Address'), 
        datafileTabAsset.getValue(GlobalVariable.NumofColm, 53), 
        false)
    ...
    'input RT'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_InputRT'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 55))

    'input RW'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_InputRW'), datafileTabAsset.getValue(GlobalVariable.NumofColm, 56))
...
if (Integer.parseInt(datafileTabAsset.getValue(GlobalVariable.NumofColm, 
...
if (GlobalVariable.FlagFailed == 0) {
    ...
    CustomKeywords.'checkSaveProcess.checkSaveProcess.checkStatus'(Integer.parseInt(datafileTabAsset.getValue(
