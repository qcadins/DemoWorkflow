...
if (datafileTabApplication.getValue(
	...
	'verify input error'
    CustomKeywords.'Function.verifyInputErrorLookUp'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Cancel'), '6.TabApplicationData', GlobalVariable.NumofColm)
}
