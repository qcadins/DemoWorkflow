...
def verifyMatch() {
    'Koneksi database'
    String urlLOS = (((datafileLogin.getValue(1, 8) + ';instanceName=') + datafileLogin.getValue(2, 8)) + ';databaseName=') + 
    datafileLogin.getValue(5, 9)

    Sql sqlConnectionLOS = CustomKeywords.'dbConnection.connectDB.connect'(urlLOS, datafileLogin.getValue(3, 8), datafileLogin.getValue(
            4, 8), datafileLogin.getValue(6, 8))
