...
'Klik tab asset'
WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/buttonTabAsset'))
...
String office = WebUI.getText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabApplicationData/label_OriginalOfficeFL4W'))

'click button supplier lookup'
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Supplier Name_FL4W'))
...
if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/a_Select'), GlobalVariable.TimeOut, 
    ...
    suppName = WebUI.getText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/span_suppNameLookup'))
...
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Asset Name_FL4W'))
...
'input asset price'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Asset Price_FL4W'), 
...
if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 22).length() > 0) {
    ...
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_BPKB City Issuer_FL4W'))
...
'input notes'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/textarea_NotesFL4W'), findTestData(excelPathTabAsset).getValue(
...
if(GlobalVariable.RoleCompany=="Testing" && GlobalVariable.CheckRuleCompany == "Yes"){
	...
	HashMap<String, ArrayList> resultAssetValidation =  CustomKeywords.'assetData.checkAssetValidation.checkValidation'(sqlConnectionLOS, sqlConnectionFOU, findTestData(excelPathCustomerCompany).getValue(GlobalVariable.NumofColm,12), findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset,12), findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset,17), findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset,18).toUpperCase(), findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset,25), findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofAsset,20))
...
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-FL4W'))

if(GlobalVariable.RoleCompany=="Testing" && GlobalVariable.CheckRuleCompany == "Yes"){
	'verify dp percentage default sesuai rule'
	WebUI.verifyEqual(Double.parseDouble(resultDP.get(0)),Double.parseDouble(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-FL4W'),'value').replace(" %","")))
	...
	if(resultDP.get(1)=="DEF" && findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 26) == 'Percentage'){
		...
		WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-FL4W'),'readonly',GlobalVariable.TimeOut)
	}
		...
		WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-FL4W'),'readonly',GlobalVariable.TimeOut)
	}
	else if(resultDP.get(1)=="LOCK"){
		'verify dp percentage terlock'
		WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-FL4W'),'readonly',GlobalVariable.TimeOut)
		
		'verify dp amount terlock'
		WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-FL4W'),'readonly',GlobalVariable.TimeOut)
	}
}
...
if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 26) == 'Percentage') {
    ...
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-FL4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 28))
}

'input chasis number'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_CHASIS NUMBER_FL4W'), findTestData(excelPathTabAsset).getValue(
        GlobalVariable.NumofAsset, 29))

'input engine number'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_ENGINE NUMBER-FL4W'), findTestData(excelPathTabAsset).getValue(
        GlobalVariable.NumofAsset, 30))

if (GlobalVariable.RoleCompany == 'Testing') {
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 26) == 'Percentage') {
        'get attribute dp amount dari confins'
        DownPaymentAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Amt)-FL4W'), 
            'value')
        ...
        DownPaymentPrctg = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Down Payment (Prctg)-FL4W'), 
            'value').replace(' %', '')
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_LICENSE PLATE NUMBER_FL4W'), findTestData(excelPathTabAsset).getValue(
        GlobalVariable.NumofAsset, 31))

if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial4_FL4W'), 
    GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
    'input serial 4'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial4_FL4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofAsset, 32), FailureHandling.OPTIONAL)
}

if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial5_FL4W'), 
    GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
    'input serial 5'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Serial5_FL4W'), findTestData(excelPathTabAsset).getValue(
...
if (CustomKeywords.'assetData.checkAssetData.checkSelfUsage'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Usage Checkbox Input FL4W'), GlobalVariable.NumofAsset, excelPathTabAsset) == true) {
    ...
    if (WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/status selfusage checkbox_FL4W'), 
        'aria-checked') == 'true') {
        'click self usage check box'
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Usage Checkbox FL4W'))
    }
    ...
    'input user name'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_User Name_FL4W'), 
    ...
    if (GlobalVariable.RoleCompany == 'Testing') {
        ...
        if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship-FL4W'), 
            userRelation) == false) {
        ...
        Integer totalUserRelation = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship-FL4W'))
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_User Relationship-FL4W'), 
...
if (CustomKeywords.'assetData.checkAssetData.checkSelfOwner'(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Owner CheckBox Input FL4W'), GlobalVariable.NumofAsset, excelPathTabAsset) == true) {
    ...
    if (WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/status self owner checkbox_FL4W'), 
        'aria-checked') == 'true') {
        'click self owner checkbox'
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/div_Self Owner CheckBox FL4W'))
    }
    ...
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 42) == 'Personal') {
        ...
        if (GlobalVariable.RoleCompany == 'Testing') {
			...
			int totalddlownerprofession = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Company Owner Profession-FL4W'))
			...
			if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Company Owner Profession-FL4W'),
    ...
    'input owner name'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Name_FL4W'), 
    ...
    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 42) == 'Personal') {
        if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 46).length() > 1) {
            ...
            WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Owner Profession_FL4W'))
	    ...
	    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Company Owner Profession-FL4W'), 
	...
	if(GlobalVariable.RoleCompany == 'Testing'){
		...
		int totalddlIDType = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_-ID Type'))
		...
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_-ID Type'),
			IDType) == false) {
		...
		int totalddlcopyaddrassetowner = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Asset Owner Copy Address_FL4W'))
		
		'get total label from ddl copyaddr asset location'
		int totalddlcopyaddrassetlocation = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation _ Copy Address'))
		...
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Asset Owner Copy Address_FL4W'),
				copyaddr) == false) {
		...
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation _ Copy Address'),
				copyaddr) == false) {
    ...
    'input id no'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Id No_FL4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofAsset, 49))

    'input owner mobile no'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Mobile Phone No_FL4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 50))

    if (findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 52) == 'Yes') {
        'select copy address'
        WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/select_Asset Owner Copy Address_FL4W'), 
            findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 53), false)

        'click button copy'
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Copy - FL4W'))
...
'click button save'
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Save-FL4W'))
...
if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Supplier Name_FL4W'), 
    GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
    'click button cancel'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/button_Cancel-FL4W'))
    ...
    if ((GlobalVariable.RoleCompany == 'Testing') && (GlobalVariable.CheckVerifStoreDBCompany == 'Yes')) {
    	...
    	WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/NAP2 - Application Data/FL4W/TabAssetDataStoreDBVerif'), [:], FailureHandling.CONTINUE_ON_FAILURE)
    }
}
...
def assetLocInput() {
    'input address'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_AddressText-FL4W'), 
        findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 54))

    'input RT'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_InputRT-FL4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofAsset, 55))

    'input RW'
    WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_InputRW-FL4W'), findTestData(excelPathTabAsset).getValue(
            GlobalVariable.NumofAsset, 56))

    'click button zipcode'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_ButtonZipcode-FL4W'))
...
def assetLocCopy() {
    ...
    'click button copy'
    WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/AssetLocation_ButtonCopy-FL4W'))
}
...
def getDataOwner() {
	...
	if(findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 41) == 'Yes'){
		...
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Id No_FL4W'),
				'value'))
		
		'add owner owner mobile no to array'
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_Owner Mobile Phone No_FL4W'),
				'value'))
	}
	...
	if(findTestData(excelPathTabAsset).getValue(GlobalVariable.NumofAsset, 41) == 'No'){
		...
		modifyObjectAssetOwnerZipcode = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/labelZipcodeAssetOwnerFL4W'),
		...
		'add zipcode to array'
		confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/labelZipcodeAssetOwnerFL4W'), 'value'))
	}
...
def checkSupplierScheme(Sql sqlConnectionLOS, Sql sqlConnectionFOU, String POName, String office){
	if (GlobalVariable.RoleCompany == 'Testing') {
		...
		String[] textTotalDataSupplier = WebUI.getText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/label_totalSupplier')).replace(
			' ', '').replace(':', ';').split(';')
...
def checkLookupAsset(Sql sqlConnectionLOS, Sql sqlConnectionFOU, String POName){
	if (GlobalVariable.RoleCompany == 'Testing') {
		...
		String[] textTotalDataAsset = WebUI.getText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/label_totalSupplier')).replace(
			' ', '').replace(':', ';').split(';')
