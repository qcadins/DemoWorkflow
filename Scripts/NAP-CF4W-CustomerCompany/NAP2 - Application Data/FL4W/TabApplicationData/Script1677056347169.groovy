...
if (findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 21).length() > 0) {
	...
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabApplicationData/MOU Customer'),
...
WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabApplicationData/button_ATTRIBUTE MASTER CODE'))
