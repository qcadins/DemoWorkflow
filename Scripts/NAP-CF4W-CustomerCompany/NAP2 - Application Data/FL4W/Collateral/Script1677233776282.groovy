...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Manufacturing Year'), 
    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 17))

if(WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Condition'), 'disabled', GlobalVariable.TimeOut, FailureHandling.OPTIONAL)){
	'select collateral condition'
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Condition'), 
	    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 18), false)
}

if(WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Usage'), 'disabled', GlobalVariable.TimeOut, FailureHandling.OPTIONAL)){
	'select collateral usage'
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Usage'), 
	    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 19), false)
}

'input collateral tax date'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Collateral Tax Date'), 
    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 20))

'input collateral price'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Collateral Price'), 
    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 21))

'input collateral porsion percentage'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Collateral Portion Prctg'), 
    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 22))

'input collateral note'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Collateral Notes'), 
    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 25))

'input collateral serial 1'
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 1'), 
    findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 26))

if(WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 2'), GlobalVariable.TimeOut, FailureHandling.OPTIONAL)){	
	'input collateral serial 2'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 2'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 27))
}

if(WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 3'), GlobalVariable.TimeOut, FailureHandling.OPTIONAL)){
	'input collateral serial 3'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 3'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 28))
}

if(WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 4'), GlobalVariable.TimeOut, FailureHandling.OPTIONAL)){
	'input collateral serial 4'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 4'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 29))
}

if(WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 5'), GlobalVariable.TimeOut, FailureHandling.OPTIONAL)){
	'input collateral serial 5'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Serial No 5'),
...
if (CustomKeywords.'assetData.checkAssetData.checkSelfOwner'(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/checkBox_Self Owner Status'), GlobalVariable.NumofCollateral, 34, excelPathCollateral) == true) {
	...
	WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/checkBox_Self Owner'))
	...
	if (WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/checkBox_Self Owner Status'),
		'aria-checked') == 'true') {
		'click self owner checkbox'
		WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/checkBox_Self Owner'))
	}
	...
	if (findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 35) == 'Personal') {
		...
		WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Radio_Personal'))
		...
		if (GlobalVariable.RoleCompany == 'Testing') {
			...
			if (WebUI.verifyOptionsPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Relationship'),
				...
				CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
					GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'value Owner relationship Personal')

				GlobalVariable.FlagFailed = 1
			}
			
			'Ambil nilai jumlah option/pilihan owner relationship dari confins'
			Integer totalOwnerPersonalRelation = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Relationship'))
			...
			if (WebUI.verifyEqual(totalOwnerPersonalRelation, countOwnerPersonalRelation) == false) {
				'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
				CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
					GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'Jumlah Owner Relationship Personal')
		...
		WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Radio_Company'))
		...
		if (GlobalVariable.RoleCompany == 'Testing') {
			...
			if (WebUI.verifyOptionsPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Relationship'),
				...
				'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
				CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
					GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'Value Owner Relationship Company')

				GlobalVariable.FlagFailed = 1
			}
			
			'Ambil nilai jumlah option/pilihan owner relationship dari confins'
			Integer totalOwnerCompanyRelation = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Relationship'))

			'Verif jumlah owner relationship yang muncul pada confins sesuai dengan jumlah owner relationship pada db'
			if (WebUI.verifyEqual(totalOwnerCompanyRelation, countOwnerCompanyRelation) == false) {
				'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
				CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
					GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'Jumlah Owner Relationship Company')
			...
			int totalddlownerprofession = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Profession'))
			...
			if (WebUI.verifyOptionsPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Profession'),
				ownerprofession) == false) {
		
				'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
				CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral, GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'ownerprofession')
	...
	'input owner name'
	WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Owner Name'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 36))

	'select owner relationship'
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Relationship'),
	...
	if (findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 35) == 'Personal') {
		if (findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 39).length() > 1) {
			...
			WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Lookup Owner Profession'))

			'input profession code'
			WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Profession Code'),
		...
		WebUI.selectOptionByLabel(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Profession'),
	...
	if(GlobalVariable.RoleCompany == 'Testing'){
		...
		int totalddlIDType = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Type Id'))
	
		'verify total ddl IDType confins = total ddl db'
		WebUI.verifyEqual(totalddlIDType, IDType.size())
		
		'verify isi ddl IDType confins = db'
		if (WebUI.verifyOptionsPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Type Id'),
			IDType) == false) {
	
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral, GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'IDType')
		...
		int totalddlcopyaddrassetowner = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Address Type Owner'))
		
		'get total label from ddl copyaddr asset location'
		int totalddlcopyaddrassetlocation = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Address Type Location'))
		...
		if (WebUI.verifyOptionsPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Address Type Owner'),
				copyaddr) == false) {
				
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral, GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'copyaddr asset owner')
					
			(GlobalVariable.FlagFailed)++
		}
				
		'verify isi ddl copyaddr asset location confins = db'
		if (WebUI.verifyOptionsPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Address Type Location'),
				copyaddr) == false) {
						
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral, GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'copyaddr asset location')
	...
	'select id type'
	WebUI.selectOptionByLabel(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Owner Type Id'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 41), false)
	
	'input id no'
	WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Owner Id No'), findTestData(excelPathCollateral).getValue(
			GlobalVariable.NumofCollateral, 42))
	
	'input owner mobile no'
	WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Owner Mobile Phone'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 43))

	if (findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 45) == 'Yes') {
		'select copy address'
		WebUI.selectOptionByLabel(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Address Type Owner'),
			findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 46), false)
		
		'click button copy'
		WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Copy Address Owner'))
		...
		'input address'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Address Owner'),
			findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 47))
		
		'input RT'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_RT Owner'), findTestData(excelPathCollateral).getValue(
				GlobalVariable.NumofCollateral, 48))

		'input RW'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_RW Owner'), findTestData(excelPathCollateral).getValue(
				GlobalVariable.NumofCollateral, 49))

		'click button Zipcode'
		WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Lookup Zipcode Owner'))
		
		'input Zipcode'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Zipcode'),
			findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 50))

		'input kelurahan'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Kelurahan'),
			findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 51))

		'input Kecamatan'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Kecamatan'),
			findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 52))

		'input Kota'
		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Kota'),
...
if(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 12).equalsIgnoreCase('New Collateral')){
	'click button save'
	WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Save'))
}else if(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 12).equalsIgnoreCase('Existing Collateral')){
	'click button save'
	WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_SaveExistinCol'))
}

Integer iscompleteMandatory = Integer.parseInt(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 4))
...
if (GlobalVariable.FlagFailed == 0) {
	...
	CustomKeywords.'checkSaveProcess.checkSaveProcess.checkStatus'(iscompleteMandatory, findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_AddCollateral'),
	...
	if (iscompleteMandatory == 0) {
		...
		'cek validasi'
		CustomKeywords.'checkSaveProcess.checkSaveProcess.checkValidasi'(errorValObject, GlobalVariable.NumofCollateral, '7b.CollateralData')
	}
}

if (WebUI.verifyElementPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Cancel'),
	GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
	'click button cancel'
	WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Cancel'))
	...
	if ((GlobalVariable.RoleCompany == 'Testing') && (GlobalVariable.CheckVerifStoreDBCompany == 'Yes')) {		
		if(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 12).equalsIgnoreCase('New Collateral')){			
			...
			WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/NAP2 - Application Data/FL4W/TabCollateralDataStoreDBVerif'),
				[:], FailureHandling.CONTINUE_ON_FAILURE)
		}else if(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 12).equalsIgnoreCase('Existing Collateral')){
			'call test case store db asset data'
			WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/NAP2 - Application Data/FL4W/TabCollateralDataStoreDBVerif - Existing'),
				[:], FailureHandling.CONTINUE_ON_FAILURE)
		}
	}
}
...
def checkVerifyEqualOrMatch(Boolean isMatch) {
	if ((isMatch == false) && (GlobalVariable.FlagFailed == 0)) {
		...
		CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
			GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedVerifyEqualOrMatch)
...
def assetLocInput() {
	'input address'
	WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Address Location'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 47))
	
	'input RT'
	WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_RT Location'), findTestData(excelPathCollateral).getValue(
			GlobalVariable.NumofCollateral, 48))

	'input RW'
	WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_RW Location'), findTestData(excelPathCollateral).getValue(
			GlobalVariable.NumofCollateral, 49))
	
	'click button zipcode'
	WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Zipcode Location'))
...
def collateralLocCopy() {
	'select copy address'
	WebUI.selectOptionByLabel(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/select_Address Type Location'),
		findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 46), false)

	'click button copy'
	WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_Copy Location'))
}
...
def getDataOwner() {
	...
	if(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 34) == 'Yes'){
		...
		confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Owner Name'),
				'value'))
		
		Select ownerRelation = new Select(DriverFactory.getWebDriver().findElement(By.xpath('//*[@id="AddCollOwner"]/div[3]/div[1]/select')))
		Select ownerProfession = new Select(DriverFactory.getWebDriver().findElement(By.xpath('//*[@id="AddCollOwner"]/div[4]/div[1]/select')))
		...
		confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Owner Id No'),
			'value'))
		
		'add owner owner mobile no to array'
		confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Owner Mobile Phone')	,
				'value'))
	}
	
	'add address to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_Address Owner'),
			'value'))
	
	'add RT to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_RT Owner'),
			'value'))

	'add RW to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/input_RW Owner'),
			'value'))

	if(findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 34) == 'No'){
		'modify Asset Owner Zipcode'
		modifyObejctCollateralOwnerZipcode = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/label_Zipcode Owner'),
		...
		'add zipcode to array'
		confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/label_Zipcode Owner'), 'value'))
	}
	
	'add kelurahan to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/label_Kelurahan Owner'),
			'value'))

	'add kecamatan to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/label_Kecamatan Owner'),
			'value'))

	'add kota to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/label_Kota Owner'),
			'value'))
...
def verifyInputLookup() {
    if (WebUI.verifyElementPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/a_Select'), GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
        'click button select'
        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/a_Select'))
    } else {
        'click x'
        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/button_X'))
...
def checkDDL(Sql sqlConnectionFOU){
	if(GlobalVariable.RoleCompany == 'Testing'){
		...
		Integer totalAssetUsage = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Usage'))
		...
		if (WebUI.verifyEqual(totalAssetCondition, assetCondition.size()) == false) {
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
				GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'Jumlah Asset Condition')
	
			GlobalVariable.FlagFailed = 1
		}
		
		'Verif dropdownlist asset usage yang muncul pada confins sesuai dengan array string asset usage dari db'
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Usage'),
			assetUsage) == false) {
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
				GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'Value Asset Usage')
	
			GlobalVariable.FlagFailed = 1
		}
			
		'Verif dropdownlist asset condition yang muncul pada confins sesuai dengan array string asset condition dari db'
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/Collateral/Select_Collateral Condition'),
				assetCondition) == false) {
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('7b.CollateralData', GlobalVariable.NumofCollateral,
					GlobalVariable.StatusFailed, findTestData(excelPathCollateral).getValue(GlobalVariable.NumofCollateral, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'value Asset condition')
