...
if(GlobalVariable.RoleCompany=="Testing"){
	...
	if(feeBhv[0]=="DEF"){
		...
		WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/input_Admin Fee_adminFee'),"disabled",2,FailureHandling.OPTIONAL)
	}
	else if(feeBhv[0]=="LOCK"){
		'Verif field admin fee tidak bisa diedit'
		WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/input_Admin Fee_adminFee'),"disabled",2,FailureHandling.OPTIONAL)
	}
	if(feeBhv[1]=="DEF"){
		'Verif field customer stampduty bisa diedit'
		WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/input_Customer Stampduty Fee_adminFee'),"disabled",2,FailureHandling.OPTIONAL)
	}
	else if(feeBhv[1]=="LOCK"){
		'Verif field customer stampduty tidak bisa diedit'
		WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/input_Customer Stampduty Fee_adminFee'),"disabled",2,FailureHandling.OPTIONAL)
	}
}
...
if(capinssetting=="YEARLY"){
	...
	for (int i = 1; i <= count; i++) {
		...
		if(GlobalVariable.RoleCompany=="Testing"){
			...
			WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/h4_TotalPremium'))
		...
		for (int j = 1; j <= countAddCov; j++) {
			...
			modifyAddtCovName = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/label_AddtCovName'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr["+(j+2)+"]/td[6]/div/div/label",true)
