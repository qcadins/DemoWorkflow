...
if(findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData').getValue(
	...
	if (WebUI.verifyNotMatch(WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/TableAccessoriesnodata')),
		...
		for(int i =1;i<=variable.size();i++){
			...
			modifyObjectSupplierName = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_supplierAccName'),'xpath','equals',newSupplierNameXpath,true)
			...
			modifyObjectAccName = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/input_AccName'),'xpath','equals',newAccNameXpath,true)
				...
				for(int j = 1;j<=countData;j++){
					...
					if (WebUI.verifyNotMatch(WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData/TableAccessoriesnodata')),
						'NO DATA AVAILABLE', false, FailureHandling.OPTIONAL)){
						   ...
						   if(!findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/Accessories').getValue(
							   GlobalVariable.NumofAccessories, 14).equalsIgnoreCase(WebUI.getAttribute(modifyObjectSupplierName,'value')) || !findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/Accessories').getValue(
