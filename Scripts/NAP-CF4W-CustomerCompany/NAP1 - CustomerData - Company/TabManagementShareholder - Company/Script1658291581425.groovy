...
if (WebUI.verifyElementClickable(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/button_2ManagementShareHolder'), 
        ...
        if (datafile.getValue(GlobalVariable.NumofFamily, 2) == findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(
            ...
            if (datafile.getValue(GlobalVariable.NumofFamily, 3) == 'Input Data') {
                ...
                if (datafile.getValue(GlobalVariable.NumofFamily, 4).equalsIgnoreCase('Personal')) {
                    ...
                    if (datafile.getValue(GlobalVariable.NumofFamily, 17).length() > 1) {
                        ...
                        if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/a_Select'), 
                            ...
                            'click select'
                            WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/a_Select'))
                        } else {
                            'click X'
                ...
                if (datafile.getValue(GlobalVariable.NumofFamily, 4).equalsIgnoreCase('Personal')) {
                    ...
                    WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/button_ShareHolderLegalName'))

                    'input customer no'
                    WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/input_Customer No_custNoId'), 
                        datafile.getValue(GlobalVariable.NumofFamily, 6))

                    'input customer name'
                    WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/input_Customer Name_custNameId'), 
                        datafile.getValue(GlobalVariable.NumofFamily, 7))

                    'input ID No'
                    WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/input_Id No_IdNoId'), 
                        datafile.getValue(GlobalVariable.NumofFamily, 8))

                    'click search'
                    WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/button_Search'))

                    'verify input error'
                    if (WebUI.verifyElementPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/a_Select'), 
                        10, FailureHandling.OPTIONAL)) {
                        'click select'
                        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/a_Select'))
                    } else {
                        'click X'
                        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/Button_X'))

                        'click button cancel'
                        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Personal/button_Cancel'))
                    ...
                    WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/button_Shareholder Legal Name_btn btn-raised btn-primary'))

                    'input customer no'
                    WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/input_Customer No_custNoId'), 
                        datafile.getValue(GlobalVariable.NumofFamily, 39))

                    'input customer name'
                    WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/input_Customer Name_custNameId'), 
                        datafile.getValue(GlobalVariable.NumofFamily, 40))

                    'input NPWP'
                    WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/input_NPWP_NpwpId'), 
                        datafile.getValue(GlobalVariable.NumofFamily, 41))

                    'click button search'
                    WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/button_Search'))

                    'verify input error'
                    if (WebUI.verifyElementPresent(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/a_Select'), 
                        10, FailureHandling.OPTIONAL)) {
                        'click select'
                        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/a_Select'))
                    } else {
                        'click X'
                        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/Button_X'))

                        'click button cancel'
                        WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/Company/button_Cancel'))
    ...
    'click button save'
    WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabManagementShareholderData/button_Save'))
}
