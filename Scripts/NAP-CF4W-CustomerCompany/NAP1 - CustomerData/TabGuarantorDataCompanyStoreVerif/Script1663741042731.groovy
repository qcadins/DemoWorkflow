...
String result = CustomKeywords.'dbconnection.CustomerDataVerif.GuarantorStoreDataCompany'(sqlconnection, findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabGuarantorCompany').getValue(
