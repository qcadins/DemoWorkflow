    ...
    1); (GlobalVariable.NumofMS)++) {
        if (datafile.getValue(GlobalVariable.NumofMS, 12) == findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(
            ...
            if (WebUI.verifyElementPresent(modifyNewMSName, 5, FailureHandling.OPTIONAL)) {
                ...
                WebUI.getText(modifyNewMSTypeName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofMS, 14))) || 
                (WebUI.getText(modifyNewMSName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofMS, 52)) && WebUI.getText(
                    modifyNewMSTypeName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofMS, 14)))) || (WebUI.getText(
                    modifyNewMSName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofMS, 62)) && WebUI.getText(
                    modifyNewMSTypeName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofMS, 14)))) {
                    if (WebUI.verifyElementPresent(modifyNewButtonEdit, 5, FailureHandling.OPTIONAL)) {
                        ...
                        if (datafile.getValue(GlobalVariable.NumofMS, 13) == 'Input Data') {
                            if (datafile.getValue(GlobalVariable.NumofMS, 14).equalsIgnoreCase('Personal')) {
                                ...
                                if (((datafile.getValue(GlobalVariable.NumofMS, 21) != 'E-KTP') && (datafile.getValue(
                                    GlobalVariable.NumofMS, 21) != 'NPWP')) && (datafile.getValue(GlobalVariable.NumofMS, 
                                    21) != 'AKTA')) {
				...
				if(GlobalVariable.NumofMS == (Integer.parseInt(GlobalVariable.CountAManagementShareholder) + 1)){
                    'click button edit'
                    WebUI.click(modifyNewButtonEdit, FailureHandling.OPTIONAL)
