    ...
    1); (GlobalVariable.NumofFamily)++) {
        if (datafile.getValue(GlobalVariable.NumofFamily, 12) == findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(
            ...
            if (WebUI.verifyElementPresent(modifyNewMSName, 5, FailureHandling.OPTIONAL)) {
                if (((WebUI.getText(modifyNewMSName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofFamily, 19)) && 
                WebUI.getText(modifyNewMSTypeName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofFamily, 14))) || 
                (WebUI.getText(modifyNewMSName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofFamily, 52)) && WebUI.getText(
                    modifyNewMSTypeName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofFamily, 14)))) || (WebUI.getText(
                    modifyNewMSName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofFamily, 62)) && WebUI.getText(
                    modifyNewMSTypeName).equalsIgnoreCase(datafile.getValue(GlobalVariable.NumofFamily, 14)))) {
                    if (WebUI.verifyElementPresent(modifyNewButtonEdit, 5, FailureHandling.OPTIONAL)) {
                        ...
                        if (datafile.getValue(GlobalVariable.NumofFamily, 13) == 'Input Data') {
                            if (datafile.getValue(GlobalVariable.NumofFamily, 14).equalsIgnoreCase('Personal')) {
                                ...
                                if (((datafile.getValue(GlobalVariable.NumofFamily, 21) != 'E-KTP') && (datafile.getValue(
                                    GlobalVariable.NumofFamily, 21) != 'NPWP')) && (datafile.getValue(GlobalVariable.NumofFamily, 
                                    21) != 'AKTA')) {
                                ...
                                if (datafile.getValue(GlobalVariable.NumofFamily, 62).equalsIgnoreCase('Instansi Publik Daerah') || 
                                datafile.getValue(GlobalVariable.NumofFamily, 62).equalsIgnoreCase('Instansi Publik Pusat')) {
                                    'input shareholder name'
                            ...
                            if (datafile.getValue(GlobalVariable.NumofFamily, 14).equalsIgnoreCase('Personal') || datafile.getValue(
                            ...
                            if (datafile.getValue(GlobalVariable.NumofFamily, 14).equalsIgnoreCase('Personal')) {
                                ...
                                if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP1-CustomerData/TabManagementShareholderData/Personal/a_Select'), 
                                    ...
                                    CustomKeywords.'writetoexcel.writeToExcel.writeToExcelFunction'(GlobalVariable.DataFilePath, 
                                        '2.TabManagementShareholderData', 0, GlobalVariable.NumofFamily - 1, GlobalVariable.StatusFailed)

                                    'Write To Excel GlobalVariable.StatusReasonLookup'
                                    CustomKeywords.'writetoexcel.writeToExcel.writeToExcelFunction'(GlobalVariable.DataFilePath, 
                                        '2.TabManagementShareholderData', 1, GlobalVariable.NumofFamily - 1, GlobalVariable.StatusReasonLookup)
                        ...
                        if (Integer.parseInt(datafile.getValue(GlobalVariable.NumofFamily, 4)) == 0 && GlobalVariable.FlagFailed==0) {
                            'Check alert'
                            GlobalVariable.FlagFailed=CustomKeywords.'checkSaveProcess.checkSaveProcess.checkAlert'(GlobalVariable.NumofFamily, '2.TabManagementShareholderData')
                        }
                        
                        'verify flagfailed lookup -- 0 '
                        if (GlobalVariable.FlagFailed == 0) {
                            'Check save Process write to excel'
                            CustomKeywords.'checkSaveProcess.checkSaveProcess.checkStatus'(Integer.parseInt(datafile.getValue(
                                        GlobalVariable.NumofFamily, 4)), findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP1-CustomerData/TabManagementShareholderData/Tableheadermanagementshareholder'), 
