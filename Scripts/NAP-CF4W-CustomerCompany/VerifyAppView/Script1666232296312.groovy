...
'verify office'
CustomKeywords.'tripleVerifyMatch.TripleVerifyMatch.verifyMatch'(findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(GlobalVariable.NumofColm, 16).toUpperCase(), WebUI.getText(findTestObject('Object Repository/AppView/Label Cust No')).toString().toUpperCase(), (result[index++]).toString().toUpperCase())

'verify customer name'
CustomKeywords.'tripleVerifyMatch.TripleVerifyMatch.verifyMatch'(findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(GlobalVariable.NumofColm, 19).toUpperCase(), WebUI.getText(findTestObject('Object Repository/AppView/Customer Name')).toString().toUpperCase(), (result[index++]).toString().toUpperCase())
...
//CustomKeywords.'tripleVerifyMatch.TripleVerifyMatch.verifyMatch'(findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(GlobalVariable.NumofColm, 12), WebUI.getText(findTestObject('Object Repository/AppView/Product Offering Name')).toString().toUpperCase(), (result[index++]).toString().toUpperCase())

'verify tenor'
CustomKeywords.'tripleVerifyMatch.TripleVerifyMatch.verifyMatch'(findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabApplicationData').getValue(GlobalVariable.NumofColm, 20).toUpperCase(), WebUI.getText(findTestObject('Object Repository/AppView/Tenor')).toString().toUpperCase(), (result[index++]).toString().toUpperCase())
...
//CustomKeywords.'tripleVerifyMatch.TripleVerifyMatch.verifyMatch'(findTestData('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabAssetData').getValue(GlobalVariable.NumofColm, 17), WebUI.getText(findTestObject('Object Repository/AppView/Asset Name')).toString().toUpperCase(), (result[index++]).toString().toUpperCase())

'verify customer model'
CustomKeywords.'tripleVerifyMatch.TripleVerifyMatch.verifyMatch'(findTestData('NAP-CF4W-CustomerCompany/NAP1-CustomerData-Company/TabCustomerData').getValue(GlobalVariable.NumofColm, 22).toUpperCase(), WebUI.getText(findTestObject('Object Repository/AppView/Customer Model')).toString().toUpperCase(), (result[index++]).toString().toUpperCase())
