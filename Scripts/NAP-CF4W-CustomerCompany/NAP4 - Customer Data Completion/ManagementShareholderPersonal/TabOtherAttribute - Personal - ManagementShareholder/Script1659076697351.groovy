...
if (GlobalVariable.Role == 'Testing') {
	...
	checkVerifyEqualOrMatch(WebUI.verifyEqual(CustomKeywords.'nap4Data.checkNAP4.countAttributeListPersonal'(sqlconnectionFOU), variable.size()))
    ...
    'verify total data lookup confins == total data lookup db'
    arrayMatch.add(WebUI.verifyEqual(CustomKeywords.'nap4Data.checkNAP4.countDepartmentAML'(sqlconnectionFOU), Integer.parseInt(totaldata)))
    ...
    'verify total data lookup confins == total data lookup db'
    arrayMatch.add(WebUI.verifyEqual(CustomKeywords.'nap4Data.checkNAP4.countAuthorityAML'(sqlconnectionFOU), Integer.parseInt(totaldata)))
