...
if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/a_Select'), 
    ...
    CustomKeywords.'customizeKeyword.writeToExcel.writeToExcelFunction'(GlobalVariable.DataFilePath, '3.JobData', 0, GlobalVariable.NumofMS - 
        1, GlobalVariable.StatusFailed)

    'write to excel reason lookup'
    CustomKeywords.'customizeKeyword.writeToExcel.writeToExcelFunction'(GlobalVariable.DataFilePath, '3.JobData', 1, GlobalVariable.NumofMS - 
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/select_JobPosition'), 
    GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 44), false)
...
if (WebUI.verifyElementNotChecked(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Is Well Known Company_ng-untouched ng-pristine ng-valid'), 
    ...
    if (GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 45) == 'Yes') {
    ...
    2)) {
    'check is well known company'
    if (GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 45) == 'No') {
        WebUI.click(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Is Well Known Company_ng-untouched ng-pristine ng-valid'))
    }
}
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Company Name'), 
    GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 46))
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Industry Type Code'), 
    GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 47))
...
if (GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 49).length() > 0) {
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/select_--Select One-- Big  Medium  Small'), 
        GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 49), false)
}
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Start Working Date_form-control ng-untouched ng-pristine ng-valid'), 
    GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 50))
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Job Title Name_form-control ng-untouched ng-pristine ng-valid'), 
    GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 51))
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/input_Number of Employee_form-control ng-untouched ng-pristine ng-valid'), 
    GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 52))

if (GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 53).length() > 0) {
    ...
    WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/JobDataSME - Personal/select_--Select One-- Domestic Investment  Foreign Investment'), 
        GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofMS, 53), false)
}
