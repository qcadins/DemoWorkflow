...
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_CompanyName'), findTestData(GlobalVariable.excelPath).getValue(
...
'input job title'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Job Title Name'), findTestData(GlobalVariable.excelPath).getValue(
...
'input address'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/textarea_Address_'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 55))

'input RT'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_RT'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 56))

'input RW'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_RW'), findTestData(GlobalVariable.excelPath).getValue(
...
'input kota'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Kota_kota'), findTestData(GlobalVariable.excelPath).getValue(
...
'input note'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/textarea_notes'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 62), FailureHandling.OPTIONAL)

'input phone1 Area'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 1_Area'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 63), FailureHandling.OPTIONAL)

'input phone1 number'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 1_Number'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 64), FailureHandling.OPTIONAL)

'input phone1 Extension'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 1_Ext'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 65), FailureHandling.OPTIONAL)

'input phone2 area'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 2_Area'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 66), FailureHandling.OPTIONAL)

'input phone2 number'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 2_Number'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 67), FailureHandling.OPTIONAL)

'input phone2 extension'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 2_Ext'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 68), FailureHandling.OPTIONAL)

'input phone3 area'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 3_Area'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 69), FailureHandling.OPTIONAL)

'input phone3 number'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 3_Number'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 70), FailureHandling.OPTIONAL)

'input phone3 extension'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Phone 3_Ext'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 71), FailureHandling.OPTIONAL)

'input fax'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Fax_Area'), findTestData(GlobalVariable.excelPath).getValue(
        GlobalVariable.ColmNAP4, 72), FailureHandling.OPTIONAL)

'input fax'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/input_Fax_Number'), findTestData(GlobalVariable.excelPath).getValue(
...
def checkDDL() {
    if (GlobalVariable.RoleCompany == 'Testing') {
        ...
        if (WebUI.verifyOptionsPresent(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataEmployee/select_Ownership OtherBusinessAddress'), 
            ...
            'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
            CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('3.JobData', GlobalVariable.ColmNAP4, 
                GlobalVariable.StatusFailed, findTestData(GlobalVariable.excelPath)(GlobalVariable.ColmNAP4, 2) + ';' + GlobalVariable.ReasonFailedDDL + 'oth biz ownership')
