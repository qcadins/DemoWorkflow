...
def getDataFile(){
	if(GlobalVariable.APPSTEP == 'CUSTOMER'){
		...
		'get data file path'
		GlobalVariable.excelPath = CustomKeywords.'dbConnection.connectDB.getExcelPath'("\\Excel\\"+ GlobalVariable.LOB +"\\2.2.5 CustomerDataCompletion-Company - GuarantorCompany.xlsm")
