...
if (GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofGuarantor, 12).equalsIgnoreCase('Input Data')) {
	...
	if (((GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofGuarantor, 16) != 'E-KTP') && (GlobalVariable.FindDataFile.getValue(
		GlobalVariable.NumofGuarantor, 16) != 'NPWP')) && (GlobalVariable.FindDataFile.getValue(GlobalVariable.NumofGuarantor, 16) !=
	'AKTA')) {
	...
	if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerCompany/NAP4-CustomerDataCompletion-Company/CustomerPersonal/EmergencyContact-Customer/a_Select'),
		...
		CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('4.EmergencyContact', GlobalVariable.NumofGuarantor, GlobalVariable.StatusFailed, GlobalVariable.StatusReasonLookup)
