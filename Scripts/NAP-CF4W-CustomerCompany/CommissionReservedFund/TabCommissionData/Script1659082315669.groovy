...
if (GlobalVariable.RoleCompany == 'Testing') {
    ...
    for (int i = 0; i < countIncomeInfo; i++) {
        ...
        if (i == (countIncomeInfo - 1)) {
            ...
            CustomKeywords.'Function.checkVerifyEqualOrMatch'(WebUI.verifyMatch(WebUI.getText(modifyObjectMaxAllocatedAmount), WebUI.getText(modifyObjectRemainingAllocatedAmount), 
        ...
        CustomKeywords.'Function.checkVerifyEqualOrMatch'(WebUI.verifyMatch(WebUI.getText(modifyObjectIncomeInfoAmt), WebUI.getText(modifyObjectRemainingInfoAmt), 
                false), '12.TabCommissionData', GlobalVariable.NumofColm)
        ...
        if ((GlobalVariable.CheckRuleCompany == 'Yes') && (GlobalVariable.FirstTimeEntry == 'Yes')) {
            ...
            if (WebUI.verifyMatch(textIncomeInfo, ('.*' + (refundFrom[i])) + '.*', true)) {
                ...
                if (WebUI.verifyEqual(Math.round(Double.parseDouble(textIncomeInfoAmt.replace(',', ''))), Math.round(getAmountFromAppDB * 
                    ...
                    CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('12.TabCommissionData', GlobalVariable.NumofColm, 
                        GlobalVariable.StatusFailed, GlobalVariable.ReasonFailedVerifyRule)
...
if (variableSupp.size() > 0) {
    ...
    String deleteSupp = datafileCommission.getValue(GlobalVariable.NumofColm, supRow + 1)
    ...
    if (supplierName.equalsIgnoreCase(deleteSupp)) {
        ...
        String supplierCode = CustomKeywords.'commissionReserveFundData.checkCommissionCode.checkSupplierCode'(sqlConnection, 
            supplierName)
        ...
        for (int i = 1; i <= countAllocateCommission; i++) {
            def modifyObjectCommissionAmt

            def modifyObjectCommissionPercentage

            def modifyObjectAllocateCommission
            ...
            if (allocationType == 'Amount') {
                if (datafileCommission.getValue(GlobalVariable.NumofColm, ((2 * i) + 1) + supRow) != '') {
                    ...
                    WebUI.setText(modifyObjectCommissionAmt, datafileCommission.getValue(GlobalVariable.NumofColm, ((2 * 
                            i) + 1) + supRow), FailureHandling.OPTIONAL)
                }
                ...
                if (datafileCommission.getValue(GlobalVariable.NumofColm, ((2 * i) + 2) + supRow) != '') {
                    ...
                    WebUI.setText(modifyObjectCommissionPercentage, datafileCommission.getValue(GlobalVariable.NumofColm, 
                            ((2 * i) + 2) + supRow), FailureHandling.OPTIONAL)
                }
            ...
            if (GlobalVariable.RoleCompany == 'Testing') {
                ...
                if ((amt != 0) && (pctg != 0)) {
                    ...
                    CustomKeywords.'Function.checkVerifyEqualOrMatch'(WebUI.verifyEqual(Math.round((pctg / 100) * incomeInfoAmt), amt), '12.TabCommissionData', 
                        GlobalVariable.NumofColm)

                    'Verify hasil hitungan amount dengan percentage'
                    CustomKeywords.'Function.checkVerifyEqualOrMatch'(WebUI.verifyEqual(Math.round(((amt / incomeInfoAmt) * 100) * 100) / 100, Math.round(
                    ...
                    CustomKeywords.'Function.checkVerifyEqualOrMatch'(WebUI.verifyEqual(Math.round(amt), Math.round(pctg)), '12.TabCommissionData', 
                        GlobalVariable.NumofColm)
                }
            }
        }
...
if (variableSuppEmp.size() > 0) {
    ...
    for (int i = 1; i <= variableSuppEmp.size(); i++) {
        ...
        modifyObjectSuppEmpName = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_SuppEmpName'), 
            'xpath', 'equals', ('//*[@id=\'formInformationSupplierEmployee\']/div[' + (i + 1)) + ']/div/div[1]/div[2]/div/div[1]/label', 
            true)
        ...
        modifyObjectSupplierName = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_SupplierNameSuppEmp'), 
            'xpath', 'equals', ('//*[@id=\'formInformationSupplierEmployee\']/div[' + (i + 1)) + ']/div/div[2]/div[4]/label', 
            true)
        ...
        modifyObjectSupplierEmpPos = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_SuppEmpPosition'), 
            'xpath', 'equals', ('//*[@id=\'formInformationSupplierEmployee\']/div[' + (i + 1)) + ']/div/div[2]/div[2]/label', 
            true)
        ...
        def deleteSuppEmpName = datafileCommission.getValue(GlobalVariable.NumofColm, suppEmpRow + 1)

        'Mengambil dan menyimpan posisi dari supplier employee dari excel yang akan didelete'
        def deleteSuppEmpPos = datafileCommission.getValue(GlobalVariable.NumofColm, suppEmpRow + 2)
            ...
            for (int j = 1; j <= deleteSuppEmpName.size(); j++) {
                ...
                if (supplierEmployeeName.equalsIgnoreCase(deleteSuppEmpName[(j - 1)]) && supplierEmpPos.equalsIgnoreCase(
                    ...
                    modifyDelSuppEmp = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/i_deleteSuppEmp'), 
                        'xpath', 'equals', ('//*[@id=\'formInformationSupplierEmployee\']/div[' + (i + 1)) + ']/div/div[1]/div[2]/div/div[2]/button/i', 
                        true)
        ...
        modifyObjectBankAccount = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/select_BankAccountSuppEmp'), 
            'xpath', 'equals', ('//*[@id=\'formInformationSupplierEmployee\']/div[' + (i + 1)) + ']/div/div[3]/div[1]/div[2]/select', 
            true)

        'Mengambil nama bank account supplier employee pada excel'
        def bankAccSuppEmp = datafileCommission.getValue(GlobalVariable.NumofColm, suppEmpRow + 3).split(';')
        ...
        String supplierEmployeeCode = CustomKeywords.'commissionReserveFundData.checkCommissionCode.checkSupplierEmployeeCode'(
            sqlConnection, supplierEmployeeName, supplierEmpPos, supplierName)
...
if (variableRef.size() > 0) {
    ...
    for (int i = 1; i <= variableRef.size(); i++) {
        ...
        modifyObjectRefName = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_RefName'), 
            'xpath', 'equals', ('//*[@id=\'formInformationReferantor\']/div[' + (i + 1)) + ']/div/div[1]/div[2]/div/div[1]/label', 
            true)
        ...
        def deleteRefName = datafileCommission.getValue(GlobalVariable.NumofColm, refRow + 1)
            ...
            for (int j = 1; j <= deleteRefName.size(); j++) {
                ...
                if (refName.equalsIgnoreCase(deleteRefName[(j - 1)])) {
                    modifyDelRef = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/i_deleteref'), 
                        'xpath', 'equals', ('//*[@id=\'formInformationReferantor\']/div[' + (i + 1)) + ']/div/div[1]/div[2]/div/div[2]/button/i', 
                        true)
        ...
        modifyObjectBankAccount = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/select_bankAccRef'), 
            'xpath', 'equals', ('//*[@id=\'formInformationReferantor\']/div[' + (i + 1)) + ']/div/div[2]/div[1]/div[2]/select', 
            true)

        'Mengambil nama bank account referantor pada excel'
        def bankAccRef = datafileCommission.getValue(GlobalVariable.NumofColm, refRow + 2).split(';')
        ...
        String refCode = CustomKeywords.'commissionReserveFundData.checkCommissionCode.checkReferantorCode'(sqlConnection, 
            refName)
        ...
        for (int j = 1; j <= countAllocateCommission; j++) {
            ...
            if (j <= countAllocateCommissionLeft) {
                modifyObjectCommissionAmt = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/input_Admin Fee Ref(Amt)'), 
                    'xpath', 'equals', ((('//*[@id=\'ListAllocated' + refCode) + '\']/div/div/div[1]/div[') + j) + ']/div/div[1]/input', 
                    true)
                ...
                modifyObjectCommissionPercentage = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/input__AdminFee Ref ()'), 
                    'xpath', 'equals', ((('//*[@id=\'ListAllocated' + refCode) + '\']/div/div/div[1]/div[') + j) + ']/div/div[2]/input', 
                    true)
                ...
                modifyObjectAllocateCommission = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_Allocate Commission Ref'), 
                    'xpath', 'equals', ((('//*[@id=\'ListAllocated' + refCode) + '\']/div/div/div[1]/div[') + j) + ']/div/label[1]', 
                    true)
            } else {
                modifyObjectCommissionAmt = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/input_Admin Fee Ref(Amt)'), 
                    'xpath', 'equals', ((('//*[@id=\'ListAllocated' + refCode) + '\']/div/div/div[2]/div[') + j) + ']/div/div[1]/input', 
                    true)

                modifyObjectCommissionPercentage = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/input__AdminFee Ref ()'), 
                    'xpath', 'equals', ((('//*[@id=\'ListAllocated' + refCode) + '\']/div/div/div[2]/div[') + j) + ']/div/div[2]/input', 
                    true)

                modifyObjectAllocateCommission = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_Allocate Commission Ref'), 
                    'xpath', 'equals', ((('//*[@id=\'ListAllocated' + refCode) + '\']/div/div/div[2]/div[') + j) + ']/div/label[1]', 
                    true)
            }
...
if (WebUI.verifyElementPresent(alertCalculate, 2, FailureHandling.OPTIONAL)) {
    ...
    CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('12.TabCommissionData', GlobalVariable.NumofColm, 
        GlobalVariable.StatusFailed, GlobalVariable.StatusReasonCalculateGagal)
