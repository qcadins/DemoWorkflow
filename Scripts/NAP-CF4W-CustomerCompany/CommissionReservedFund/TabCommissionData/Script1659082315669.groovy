...
allocationType = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm, 2)
...
if(variableSupp.size()>0){
	...
	String deleteSupp = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm, 4)
	...
	if (supplierName.equalsIgnoreCase(deleteSupp)) {
		...
		WebUI.selectOptionByIndex(findTestObject('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/select_BankAccountSupplier'),
			findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm, 5), FailureHandling.OPTIONAL)
		...
		for (int i = 1; i <= countAllocateCommission; i++) {
			...
			if(allocationType == "Amount"){
				...
				if(findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
					...
					WebUI.setText(modifyObjectCommissionAmt, findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
				...
				if(findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
					...
					WebUI.setText(modifyObjectCommissionPercentage, findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,
...
if(variableSuppEmp.size()>0){
	...
	for (int i = 1; i <= variableSuppEmp.size(); i++) {
		...
		def deleteSuppEmpName = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(
				GlobalVariable.NumofColm, suppEmpRow+1)
	
		'Mengambil dan menyimpan posisi dari supplier employee dari excel yang akan didelete'
		def deleteSuppEmpPos = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(
		...
		if(flagdelSuppEmployee!=0){
			...
			def bankAccSuppEmp = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(
			...
			for (int j = 1; j <= countAllocateCommission; j++) {
				...
				if(allocationType == "Amount"){
					...
					value = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + suppEmpRow).split(";",-1)
					if(findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + suppEmpRow).length()>0){
					...
					value = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 3 + suppEmpRow).split(";",-1)
					if(findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 3 + suppEmpRow).length()>0){
...
if(variableRef.size()>0){
	...
	for (int i = 1; i <= variableRef.size(); i++) {
		...
		def deleteRefName = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(
		...
		if(flagdelReferantor!=0){
			...
			def bankAccRef = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(
			...
			for (int j = 1; j <= countAllocateCommission; j++) {
				...
				if(allocationType == "Amount"){
					...
					value = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 1 + refRow).split(";",-1)
					
					if(findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 1 + refRow).length()>0){
						if(value[i-1]!=""){
							'Input Amount'
							WebUI.setText(modifyObjectCommissionAmt, value[i-1] , FailureHandling.OPTIONAL)
						}
					...
					value = findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + refRow).split(";",-1)
					
					if(findTestData('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData').getValue(GlobalVariable.NumofColm,(2 * j) + 2 + refRow).length()>0){
						if(value[i-1]!=""){
							'Input Percentage'
							WebUI.setText(modifyObjectCommissionPercentage, value[i-1] , FailureHandling.OPTIONAL)
						}
...
WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionDataVerifInfo'), [:], FailureHandling.CONTINUE_ON_FAILURE)
