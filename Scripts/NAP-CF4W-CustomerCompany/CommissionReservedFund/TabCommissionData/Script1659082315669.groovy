...
for (int i = 1; i <= variableSupp.size(); i++) {
    ...
    CustomKeywords.'commissionData.commission.count'(modifyObjectCommAmt, modifyObjectAmtAftTax, modifyObjectTax, modifyObjectVat, 
        modifyObjectDisburse, modifyObjectExpense)
}
