...
ArrayList<String> remainingInfoCom = new ArrayList<String>()

'Arraylist untuk menampung remaining info reserved fund sebelum calculate'
ArrayList<String> remainingInfoRsv = new ArrayList<String>()
...
if (GlobalVariable.RoleCompany == 'Testing') {
    ...
    for (int i = 1; i < countIncomeInfo; i++) {
        ...
        checkVerifyEqualOrMatch(WebUI.verifyMatch(textRemainingInfoAmt, String.format('%.2f', remainingInfoCom[(i - 1)]), 
...
ArrayList<String> varRemainingBfrCalculate = driver.findElements(By.cssSelector('#viewRemainIncomeInfo label'))
...
if (GlobalVariable.RoleCompany == 'Testing') {
    ...
    'Arraylist untuk menampung remaining info'
    ArrayList<String> varRemainingInfo = driver.findElements(By.cssSelector('#viewRemainIncomeInfo label'))
    ...
    checkVerifyEqualOrMatch(WebUI.verifyMatch(textRemainingAllocatedAmount, String.format('%.2f', GlobalVariable.RemainingAllocatedAmt - 
                totalAmt), false), '13.TabReservedFundData', GlobalVariable.NumofColm)
...
if ((iscompleteMandatory == 0) && (GlobalVariable.FlagFailed == 0)) {
    ...
    GlobalVariable.FlagFailed = CustomKeywords.'checkSaveProcess.checkSaveProcess.checkAlert'(GlobalVariable.NumofColm, 
        '13.TabReservedFundData')
}

if (GlobalVariable.FlagFailed == 0) {
    'Check save Process write to excel'
    CustomKeywords.'checkSaveProcess.checkSaveProcess.checkStatus'(iscompleteMandatory, findTestObject('Object Repository/NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabUploadDocument/alert_Submit'), 
