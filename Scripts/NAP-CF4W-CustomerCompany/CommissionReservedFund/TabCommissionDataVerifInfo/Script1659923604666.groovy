...
for(int i = 1;i<countRemainingInfo;i++){
	...
	modifyRemainingInfo = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_UppingRateRemaining'),'xpath','equals',xpathRemainingInfo, true)
...
modifyMaxAllocatedAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_MaxAllocatedAmtIncome'),'xpath','equals','//*[@id="viewIncomeInfo"]/div['+countIncomeInfo+']/div[2]/label',true)
...
modifyRemainingAllocatedAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerCompany/CommissionReservedFund/TabCommissionData/label_RemainingAllocatedAmount'),'xpath','equals','//div[@id="viewRemainIncomeInfo"]/div['+countRemainingInfo+']/div[2]/label',true)
