...
def DPAssetAccessory = (WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_DP ASSET  ACCESSORY  () DP'),
	FailureHandling.OPTIONAL).replace(',', '').replaceAll('\\s', '').split('/')[0]).replace('.00', '')

'get total fee capitalized value'
TotalfeeCapitalized = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL FEE CAPITALIZED'),
		FailureHandling.OPTIONAL).replace(',', '').replace('.00', '')
'get provision fee capitalized value'
ProvisionFeeCapitalize = WebUI.getAttribute(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Capitalize'),
		'value', FailureHandling.OPTIONAL).replace(',', '').replace('.00', '')
'get total insurancecap value'
TotalInsuranceCap = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL INSURANCE CAPITALIZED'),
		FailureHandling.OPTIONAL).replace(',', '').replace('.00', '')
	
'get provision percentage value'
ProvisionFeePercentage = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Percentage'),
		'value', FailureHandling.OPTIONAL).replace('%', '').replaceAll('\\s', '')
		
'get provisionfee amount value'
strProvisionFeeAmount = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Amount'),
...
def AdminCapitalizeValue = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Admin Fee Capitalize_'),
	'value', FailureHandling.OPTIONAL).split(',').join()

	'get attribute AdditionalAdminFeeValue'
def AdditionalAdminFeeValue = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Additional Admin Capitalize'),
	'value', FailureHandling.OPTIONAL).split(',').join()

	'get attribute NotaryFeeCapitalizeValue'
def NotaryFeeCapitalizeValue = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Notary Fee Capitalize'),
	'value', FailureHandling.OPTIONAL).split(',').join()

	'get attribute OtherFeeCapitalize'
def OtherFeeCapitalize = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Other Fee Capitalize'),
	'value', FailureHandling.OPTIONAL).split(',').join()

	'get attribute FiduciaFeeCapitalize'
def FiduciaFeeCapitalize = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Fiducia Fee Capitalize'),
	'value', FailureHandling.OPTIONAL).split(',').join()

	'get attribute ProvisionFeeCapitalize'
def ProvisionFeeCapitalize = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/input_Provision Fee Capitalize'),
	'value', FailureHandling.OPTIONAL).split(',').join()

	'get attribute NTF'
def NTF = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_NTF'),
	FailureHandling.OPTIONAL).replace(',', '').replace('.00', '')

	'get attribute DPAssetAccessoryValue'
def DPAssetAccessoryValue = (WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_DP ASSET  ACCESSORY  () DP'),
	FailureHandling.OPTIONAL).replace(',', '').replaceAll('\\s', '').split('/')[0]).replace('.00', '')

	'get attribute DPAssetAccessoryMinSubValue'
def DPAssetAccessoryMinSubValue = (WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_DP ASSET  ACCESSORY - SUBSIDY DP  () DP NETT'),
	FailureHandling.OPTIONAL).replace(',', '').replaceAll('\\s', '').split('/')[0]).replace('.00', '')

	'get attribute TotalAssetAccessoryPriceValue'
def TotalAssetAccessoryPriceValue = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL ASSET ACCESSORY PRICE')).replace(
	',', '').replace('.00', '')
	
	'get attribute TotalARValue'
	def TotalARValue = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL AR')).replace(
		',', '').replace('.00', '')
		
		'get attribute InterestAmountValue'
		def InterestAmountValue = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL INTEREST'), FailureHandling.OPTIONAL).replace(',','').replace('.00','')
...
int TotalFeeCapitalize = Integer.parseInt(WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL FEE CAPITALIZED')).replace(
		'.00', '').split(',').join())
...
def TotalLifeInsurance = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL LIFE INSURANCE')).replace(
	'.00', '').split(',').join()

	'get total life insurance capitalize'
def TotalLifeInsuranceCapitalize = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/label_TOTAL LIFE INSURANCE CAPITALIZED')).replace(
	'.00', '').split(',').join()
...
String NewInstallmentAmount = ('//*[@id="FinData_FinData"]/form/div[3]/table/tbody/tr[' + InstallmentSchemecount + ']/td[2]')
		 ...
		 modifyNewInstallmentAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/td_InstallmentAmount'),
		 ...
		 modifyNewPrincipalAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/td_PrincipalAmount'),
		 ...
		 modifyNewInterestAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/td_InterestAmount'),
		 ...
		 String NewOSPrincipalAmount = ('//*[@id="FinData_FinData"]/form/div[3]/table/tbody/tr[' + InstallmentSchemecount + ']/td[5]')
		  ...
		  modifyNewOSPrincipalAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/td_OSPrincipalAmount'),
		  ...
		  String NewOSInterestAmount = ('//*[@id="FinData_FinData"]/form/div[3]/table/tbody/tr[' + InstallmentSchemecount + ']/td[6]')
		   ...
		   modifyNewOSInterestAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabFinancialData/td_OSInterestAmount'),
