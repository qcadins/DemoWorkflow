    ...
    1); (GlobalVariable.NumofReferantor)++) {
        if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData').getValue(
            ...
            if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/a_Select'), 
				...
				referantorCode = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/span_referantorCode'))
                'click select'
			...
			modifyButtonViewDetail = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/i_ViewDetail'),'xpath','equals',newButtonViewDetail,true)
			...
			if(refCategory.equalsIgnoreCase("CUSTOMER")){
				...
				ArrayList<String> referantorDetail = CustomKeywords.'dbconnection.checkReferantorDetail.checkCustomerReferantor'(sqlConnection, referantorCode)
			
				'Ambil dan simpan npwp no dari confins'
				String textNPWPNo = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_NPWPNo'))
				'Ambil dan simpan npwp name dari confins'
				String textNPWPName = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_NPWPName'))
				'Ambil dan simpan address dari confins'
				String textAddress = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_Address'))
				'ambil dan simpan rt dari confins'
				String textRT = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_RT')).replace(" ","")
				'ambil dan simpan rw dari confins'
				String textRW = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_RW')).replace("/ ","")
				'ambil dan simpan kelurahan dari confins'
				String textKelurahan = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_Kelurahan'))
				'ambil dan simpan kecamatan dari confins'
				String textKecamatan = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_Kecamatan'))
				'ambil dan simpan kota dari confins'
				String textCity = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_Kota'))
				'ambil dan simpan zipcode dari confins'
				String textZipcode = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/label_Zipcode'))	
				...
				if(arrayMatch.contains(false)){
					...
					modifyObjectIndex++
					'click cancel'
					WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/button_CancelViewDetail'))
					continue
				}
				...
				'Pengecekan ke db dan simpan data-data detail referantor yang dibutuhkan dari db'
				ArrayList<String> referantorDetail = CustomKeywords.'dbconnection.checkReferantorDetail.checkAgencyReferantor'(sqlConnection, referantorCode)
				...
				'Pengecekan ke db dan simpan data-data detail referantor yang dibutuhkan dari db'
				ArrayList<String> referantorDetail = CustomKeywords.'dbconnection.checkReferantorDetail.checkMFEmployeeReferantor'(sqlConnection, referantorCode)
			...
			'click x'
			WebUI.click(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/span_XViewDetail'))
