...
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_InterestIncome'), 
...
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_InsuranceIncome'), 
    findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData').getValue(
        GlobalVariable.NumofColm, 3), FailureHandling.OPTIONAL)

'Input Promo pada Life Insurance Income'
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_LifeInsuranceIncome'), 
    findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData').getValue(
...
String textInterestIncome = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_InterestIncome'), 
    'value').replace(',', '')

BigDecimal interestIncome = Double.parseDouble(textInterestIncome)

'Menyimpan nilai promo insuranceincome'
String textInsuranceIncome = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_InsuranceIncome'), 
    'value').replace(',', '')

BigDecimal insuranceIncome = Double.parseDouble(textInsuranceIncome)

'Menyimpan nilai promo lifeinsuranceincome'
String textLifeInsuranceIncome = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_LifeInsuranceIncome'), 
    'value').replace(',', '')

BigDecimal lifeInsuranceIncome = Double.parseDouble(textLifeInsuranceIncome)

'Menyimpan nilai promo admin fee'
String textAdminFee = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_AdminFee'), 
    'value').replace(',', '')

BigDecimal adminFee = Double.parseDouble(textAdminFee)

'Menyimpan nilai promo provision feee'
String textProvisionFee = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/input_PROMO_ProvisionFee'), 
    'value').replace(',', '')
...
WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/button_Calculate'))

WebUI.delay(5)

'Menyimpan nilai Total Reserved Fund Amount dari Web CONFINS'
String totalReservedFundAmt = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/CommissionReservedFund/TabReservedFundData/label_TotalReservedFundAmt')).replace(
    ',', '').replace('.00', '')
