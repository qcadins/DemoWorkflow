...
ArrayList<String> taxRate = CustomKeywords.'commissionData.taxCalculation.checkTaxRateCompany'(sqlConnectionTAX)
...
for (int i = 1; i<=variableSupp.size(); i++){
	 ...
	 modifyObjectCalMethod = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/CommissionReservedFund/TabCommissionData/label_CalculationMethod'),'xpath','equals',newxpathCalMethod,true)
	 ...
	 ArrayList<String> taxpayerInfo = CustomKeywords.'commissionData.taxCalculation.checkTaxpayerInfo'(sqlConnectionTAX, supplierName)
	 ...
	 if(WebUI.getText(modifyObjectCalMethod).equalsIgnoreCase("NETT")){
		 ...
		 if(taxpayerInfo[0]=="C"){
		 		...
		 		ArrayList<Double> taxAmount = CustomKeywords.'commissionData.taxCalculation.calculateNettTaxCompany'(Double.parseDouble(whtRate[3]),commAmt,Double.parseDouble(whtRate[5]), 
					 Double.parseDouble(whtRate[1]),Double.parseDouble(vatRate[1]),taxpayerInfo[2])
//			 	WebUI.verifyLessThanOrEqual(Math.abs(whTax-taxAmount[0]),10)
		 ...
		 if(taxpayerInfo[0]=="C"){
			 	 ...
			 	 'Arraylist untuk menampung amount dari wht dan vat berdasarkan penghitungan'
			 	 ArrayList<Double> taxAmount = CustomKeywords.'commissionData.taxCalculation.calculateGrossTaxCompany'(Double.parseDouble(whtRate[3]),commAmt,Double.parseDouble(whtRate[5]),
					  Double.parseDouble(whtRate[1]),Double.parseDouble(vatRate[1]),Double.parseDouble(whtRate[2]),taxpayerInfo[2],taxpayerInfo[1])
//				  WebUI.verifyLessThanOrEqual(Math.abs(whTax-taxAmount[0]),10)
...
for (int j = 1; j <= variableSuppEmp.size(); j++) {
	...
	modifyObjectCalMethod = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/CommissionReservedFund/TabCommissionData/label_CalculationMethodSuppEmp'),
	...
	'Arraylist untuk menampung flag npwp exist dan is vat, serta tax kind code dari db'
	ArrayList<String> taxpayerInfo = CustomKeywords.'commissionData.taxCalculation.checkTaxpayerInfo'(sqlConnectionTAX, supplierEmployeeName)
...
for(int k=1; k <= variableRef.size(); k++){
	 ...
	 'modify object calculation method'
	 modifyObjectCalMethod = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/CommissionReservedFund/TabCommissionData/label_CalculationMethodRef'),
		 'xpath', 'equals', newxpathCalMethod, true)
	 ...
	 'Arraylist untuk menampung flag npwp exist dan is vat, serta tax kind code dari db'
	 ArrayList<String> taxpayerInfo = CustomKeywords.'commissionData.taxCalculation.checkTaxpayerInfo'(sqlConnectionTAX, refName)
...
ArrayList<BigDecimal> remainingInfoAmt = new ArrayList<BigDecimal>()
...
for(int i = 1;i<countRemainingInfo;i++){
	...
	modifyRemainingInfo = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/CommissionReservedFund/TabCommissionData/label_UppingRateRemaining'),'xpath','equals',xpathRemainingInfo, true)
...
modifyMaxAllocatedAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/CommissionReservedFund/TabCommissionData/label_MaxAllocatedAmtIncome'),'xpath','equals','//*[@id="viewIncomeInfo"]/div['+countIncomeInfo+']/div[2]/label',true)
...
modifyRemainingAllocatedAmount = WebUI.modifyObjectProperty(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/CommissionReservedFund/TabCommissionData/label_RemainingAllocatedAmount'),'xpath','equals','//div[@id="viewRemainIncomeInfo"]/div['+countRemainingInfo+']/div[2]/label',true)
