    ...
    if (WebUI.verifyNotMatch(WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabReferantorData/TableReferantornodata')), 
        ...
        for (int i = 1; i <= variable.size(); i++) {
            ...
            for (GlobalVariable.NumofReferantor = GlobalVariable.CopyAppColm; GlobalVariable.NumofReferantor <= (Integer.parseInt(
                ...
                if (datafilereferantor.getValue(GlobalVariable.NumofReferantor, 12) == findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP1-CustomerData/TabCustomerData').getValue(
                    ...
                    if (add == 1) {
                        ...
                        if (GlobalVariable.Role == 'Testing') {
                            if (refCategory != '') {
                                ...
                                String[] textTotalDataReferantor = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/NAP2-ApplicationData/TabApplicationData/label_TotalDataOfficer')).replace(
                                    ' ', '').replace(':', ';').split(';')
                        ...
                        if (WebUI.verifyElementPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/NAP2-ApplicationData/TabReferantorData/a_Select'), 
                            ...
                            if (WebUI.verifyElementPresent(modifyButtonDelete, 5, FailureHandling.OPTIONAL)) {
                                'Write To Excel GlobalVariable.StatusReasonLookup'
                                CustomKeywords.'writetoexcel.writeToExcel.writeToExcelFunction'(GlobalVariable.DataFilePath, 
                                    '5.TabReferantorData', 1, GlobalVariable.NumofReferantor - 1, GlobalVariable.ReasonFailedDelete)
                            }
                        ...
                        if (GlobalVariable.Role == 'Testing') {
                            ...
                            if (WebUI.getNumberOfTotalOption(modifySelectBankAccount) > 1) {
                                ...
                                if (refCategory.equalsIgnoreCase('Customer') || refCategory.equalsIgnoreCase('Agency')) {
                                    ...
                                    WebUI.verifyOptionSelectedByLabel(modifySelectBankAccount, '(?i)' + defaultBankAccount, 
                                        true, 2)
                                }
                            }
                        }
                ...
                if (GlobalVariable.Role == 'Testing') {
                    ...
                    if (WebUI.getNumberOfTotalOption(modifySelectBankAccount) > 1) {
                        ...
                        if (refCategory.equalsIgnoreCase('Customer') || refCategory.equalsIgnoreCase('Agency')) {
                            ...
                            'Verifikasi opsi yang terpilih secara default pada confins sesuai dengan db'
                            WebUI.verifyOptionSelectedByLabel(modifySelectBankAccount, '(?i)' + defaultBankAccount, true, 
                                2)
                        }
                    }
                }
                ...
                if (GlobalVariable.Role == 'Testing') {
                    ...
                    if (refCategory.equalsIgnoreCase('CUSTOMER')) {
                        ...
                        if (arrayMatch.contains(false)) {
                            ...
                            CustomKeywords.'writetoexcel.writeToExcel.writeToExcelFunction'(GlobalVariable.DataFilePath, 
                                '5.TabReferantorData', 1, GlobalVariable.NumofReferantor - 1, GlobalVariable.StatusReasonTidakSesuaiDB)
