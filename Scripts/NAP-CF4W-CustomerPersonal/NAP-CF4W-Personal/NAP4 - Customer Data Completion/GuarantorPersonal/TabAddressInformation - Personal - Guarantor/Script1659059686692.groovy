...
for (index = 2; index <= (countcolm + 1); index++) {
    if (GlobalVariable.findDataFile.getValue(index, 10).equalsIgnoreCase(findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP4-CustomerDataCompletion/GuarantorPersonal/CustomerDetail - Personal - Guarantor').getValue(
    ...
    for (i = 1; i <= variable.size(); i++) {
        ...
        for (Address = copyAppColm; Address <= (countcolm + 1); Address++) {
            ...
            if (GlobalVariable.findDataFile.getValue(Address, 10).length() != 0) {
                if (GlobalVariable.findDataFile.getValue(Address, 10).equalsIgnoreCase(findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP4-CustomerDataCompletion/GuarantorPersonal/CustomerDetail - Personal - Guarantor').getValue(
                        GlobalVariable.NumofGuarantor, 13))) {
...
def inputaddress() {
    ...
    if (GlobalVariable.Role == 'Testing' && GlobalVariable.CheckVerifStoreDB=="Yes") {
        ...
        WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/NAP4 - Customer Data Completion/NAP4VerifyStoreData/Personal/TabAddressVerifStoreData'), 
