...
for (i = 1; i <= 1; i++) {
    if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP1-CustomerData/TabCustomerData').getValue(
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal1'(sqlconnection, dataCustomer.getValue(
                    ...
                    GlobalVariable.NumofColm, 20))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal1LOS'(
                sqlconnection, dataCustomer.getValue(GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    11), dataCustomer.getValue(GlobalVariable.NumofColm, 20), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    3))) > 0)) {
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal2'(sqlconnection, dataCustomer.getValue(
                    GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 11), dataCustomer.getValue(
                    GlobalVariable.NumofColm, 9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal2LOS'(
                sqlconnection, dataCustomer.getValue(GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    11), dataCustomer.getValue(GlobalVariable.NumofColm, 9), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    3))) > 0)) {
            'add "LOCK" kedalam array CustomerPersonalStatus'
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal3'(sqlconnection, dataCustomer.getValue(
                    GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 11), dataCustomer.getValue(
                    GlobalVariable.NumofColm, 17))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal3LOS'(
                sqlconnection, dataCustomer.getValue(GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    11), dataCustomer.getValue(GlobalVariable.NumofColm, 17), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    3))) > 0)) {
            'add "LOCK" kedalam array CustomerPersonalStatus'
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal4'(sqlconnection, dataCustomer.getValue(
                    GlobalVariable.NumofColm, 9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal4LOS'(
                sqlconnection, dataCustomer.getValue(GlobalVariable.NumofColm, 9), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    3))) > 0)) {
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal5'(sqlconnection, dataCustomer.getValue(
                    GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 11), dataCustomer.getValue(
                    GlobalVariable.NumofColm, 9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal5LOS'(
                sqlconnection, dataCustomer.getValue(GlobalVariable.NumofColm, 18), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    11), dataCustomer.getValue(GlobalVariable.NumofColm, 9), dataCustomer.getValue(GlobalVariable.NumofColm, 
                    3))) > 0)) {
            'add "REVIEW" kedalam array CustomerPersonalStatus'
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal6'(sqlconnection, dataCustomer.getValue(
                    GlobalVariable.NumofColm, 9), dataCustomer.getValue(GlobalVariable.NumofColm, 20))) > 0) || (Integer.parseInt(
        ...
        if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal7'(sqlconnection, dataCustomer.getValue(
                    GlobalVariable.NumofColm, 9), dataCustomer.getValue(GlobalVariable.NumofColm, 17))) > 0) || (Integer.parseInt(
        ...
        if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP1-CustomerData/TabFamilyData').getValue(
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal1'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        11), dataFamily.getValue(GlobalVariable.NumofFamily, 23))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal1LOS'(
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal2'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        11), dataFamily.getValue(GlobalVariable.NumofFamily, 9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal2LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal3'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        11), dataFamily.getValue(GlobalVariable.NumofFamily, 20))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal3LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal4'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal4LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofFamily, 9), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        2))) > 0)) {
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal5'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        11), dataFamily.getValue(GlobalVariable.NumofFamily, 9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal5LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofFamily, 21), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        11), dataFamily.getValue(GlobalVariable.NumofFamily, 9), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        2))) > 0)) {
                'add "REVIEW" kedalam array FamilyPersonalStatus'
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal6'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 9), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        23))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal6LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofFamily, 9), dataFamily.getValue(GlobalVariable.NumofFamily, 
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal7'(sqlconnection, 
                    dataFamily.getValue(GlobalVariable.NumofFamily, 9), dataFamily.getValue(GlobalVariable.NumofFamily, 
                        20))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal7LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofFamily, 9), dataFamily.getValue(GlobalVariable.NumofFamily, 
        ...
        if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP1-CustomerData/TabGuarantorDataPersonal').getValue(
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal1'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        ...
                        20))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal1LOS'(
                    sqlconnection, dataFamily.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal2'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
                        9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal2LOS'(
                    sqlconnection, dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal3'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
                        17))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal3LOS'(
                    sqlconnection, dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
            ...
            'check rule 4'
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal4'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 9))) > 0) || (Integer.parseInt(
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal5'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
                        9))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal5LOS'(
                    sqlconnection, dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 18), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 11), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 
                        9), dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 2))) > 0)) {
                'add "REVIEW" kedalam array GuarantorPersonalStatus'
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal6'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 9), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 20))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal6LOS'(
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal7'(sqlconnection, 
                    dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 9), dataGuarantorPersonal.getValue(
                        GlobalVariable.NumofGuarantorPersonal, 17))) > 0) || (Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRulePersonal7LOS'(
                    sqlconnection, dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal, 9), dataGuarantorPersonal.getValue(
    ...
    if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP1-CustomerData/TabGuarantorDataCompany').getValue(
        ...
        if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP1-CustomerData/TabGuarantorDataCompany').getValue(
            ...
            if ((Integer.parseInt(CustomKeywords.'dbconnection.DupCheckVerif.checkDupcheckRuleCompany1'(sqlconnection, dataGuarantorPersonal.getValue(
                    ...
                    sqlconnection, dataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorCompany, 8), dataGuarantorCompany.getValue(
