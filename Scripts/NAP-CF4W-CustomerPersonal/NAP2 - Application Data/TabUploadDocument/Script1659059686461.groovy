...
if (Integer.parseInt(GlobalVariable.CountofUploadDocument) >= 1) {
    ...
    1); (GlobalVariable.NumofUploadDocument)++) {
        if (findTestData('NAP-CF4W-CustomerPersonal/NAP-CF4W-CustomerPersonalSingle/NAP2-ApplicationData/TabUploadDocument').getValue(
            ...
            'upload file'
            CustomKeywords.'customizeKeyword.uploadFile.uploadFile'(findTestObject('NAP-CF4W-CustomerPersonal/NAP-CF4W-Personal/NAP2-ApplicationData/TabUploadDocument/img_Upload _thumbnail thumbnail-change'), 
...
public checkVerifyEqualOrMatch(Boolean isMatch){
	if(isMatch==false && GlobalVariable.FlagFailed==0){
		(new customizeKeyword.writeToExcel()).writeToExcelFunction(GlobalVariable.DataFilePath, '12.TabUploadDocument',
