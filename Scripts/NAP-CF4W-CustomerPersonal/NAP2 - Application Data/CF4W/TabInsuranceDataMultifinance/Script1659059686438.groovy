...
String appNo = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/span_AppNo'))
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_InscoBranchNameMF'),
	findTestData(excelPathTabInsurance).getValue(
		GlobalVariable.NumofColm, 26), false)

insuranceNotesCompany = findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/textarea_Insurance Notes MF')
...
buttonGenerateInsurance = findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/button_Generate Insurance')
if (findTestData(excelPathTabInsurance).getValue(
	GlobalVariable.NumofColm, 12) == 'Customer - Multifinance') {
...
GlobalVariable.InsuranceLength = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/insurancelength'),
...
if (WebUI.verifyTextNotPresent('INSURANCE FEE', false, FailureHandling.OPTIONAL)) {
	...
	CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('8.TabInsuranceData', GlobalVariable.NumofColm, GlobalVariable.StatusFailed, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofColm, 2) + ';'+GlobalVariable.StatusReasonGenerateGagal)
...
if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
	...
	adminFeeDefAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Admin Fee_adminFee'),'value')
	
	'Ambil nilai customer stamp duty dari confins'
	custStampDutyDefAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Customer Stampduty Fee_adminFee'),'value')
	...
	if(feeBhv[0]=="DEF"){
		...
		if(WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Admin Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
	}
		...
		if(WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Admin Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
		else{
			...
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelNumber'(GlobalVariable.DataFilePath, '8.TabInsuranceData', 30,
				GlobalVariable.NumofColm - 1, Integer.parseInt(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Admin Fee_adminFee'),'value').replace(",","")))
		}
	}
	if(feeBhv[1]=="DEF"){
		'Verif field customer stampduty bisa diedit'
		if(WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Customer Stampduty Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
	}
		...
		if(WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Customer Stampduty Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
		else{
			...
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelNumber'(GlobalVariable.DataFilePath, '8.TabInsuranceData', 31,
				GlobalVariable.NumofColm - 1, Integer.parseInt(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Customer Stampduty Fee_adminFee'),'value').replace(",","")))
		}
	}
}
...
if (findTestData(excelPathTabInsurance).getValue(
	...
	'Input Admin Fee'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Admin Fee_adminFee'),
		findTestData(excelPathTabInsurance).getValue(
			GlobalVariable.NumofColm, 31), FailureHandling.OPTIONAL)

	'Input Customer Stampduty Fee'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Customer Stampduty Fee_adminFee'),
		findTestData(excelPathTabInsurance).getValue(
...
if(GlobalVariable.Role == 'Testing'){
	...
	ArrayList<String> maincvg = CustomKeywords.'insuranceData.checkInsRateBase.checkMainCVGDDL'(sqlConnectionFOU)
			...
			int totalddlmaincvg = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_MainCoverage'))
			...
			if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_MainCoverage'),
					maincvg) == false) {
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_MainCoverage'),
	findTestData(excelPathTabInsurance).getValue(
...
for (int i = 1; i <= countAddCov; i++) {
	...
	modifyCheckboxAddtCov = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Flood_checkboxLabel ng-valid'),
...
'Klik apply to all'
WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/button_Apply To All'))
...
if(capinssetting=="YEARLY"){
	...
	String selectedRegion = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_AssetRegionMF'),'value')
	
	'get coverage amount from confinss'
	String covAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Coverage Amount MF'),'value').replace(",","")
	...
	for (int i = 1; i <= count; i++) {
		...
		yearNumObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/td_YearNo'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[3]",true)
		if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
			'modify object sum insured percentage'
			sumInsuredPercentObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_SumInsuredPercentage'),
		...
		//Capitalize
		capitalizeObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Capitalized'),
			'xpath', 'equals', ('//*[@id=\'insuranceCoverage\']/div[5]/table/tbody[' + i) + ']/tr[1]/td[1]/div/input', true)
	
		'Ambil nilai capitalize dari excel'
		capitalizeValue = findTestData(excelPathTabInsurance).getValue(
		...
		//Paid By
		paidByObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_PaidBy'),
		...
		modifyRandomObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/testobject'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[2]/td[5]",true)
		...
		//Main Coverage
		mainCoverageObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_MainCoverageTP'),
		...
		//Main Premi Rate
		mainPremiRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[8]/div/input",true)
		...
		if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
			...
			for(int addCovIndex = 1 ; addCovIndex <= countAddCov ; addCovIndex++){
				...
				labelAddCovPerYear = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/label_AddCovPerYear'),
		...
		for (int j = 1; j <= countAddCov; j++) {
			...
			addCovYearCheckbox = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Flood_checkboxLabel TP'),
			...
			if(flagLoad==0){
				...
				modifySumInsuredAmount = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_SumInsuredAmountFlood'),
					'xpath', 'equals', ((('//div[@id=\'insuranceCoverage\']/div[5]/table/tbody[' + i) + ']/tr[') + (j + 2)) + ']/td[7]/div/div/select',
					true)
				
				'modify additional rate object'
				modifyAddtRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_AddtRate'),'xpath','equals',"//div[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr["+(j+2)+"]/td[8]/div/span/div/input",true)
	...
	for (int i = 1; i <= count; i++) {
		...
		numOfMonthObj = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[4]",true)
	...
	if(GlobalVariable.Role=="Testing"){
		...
		String textTotalMainPremiAmt = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/label_TotalMainPremium')).replace(
			',', '')
		
		'ambil nilai total additional premi dari confins'
		String textTotalAdditionalPremiAmt = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/label_TotalAdditionalPremium')).replace(
			',', '')
		
		'ambil nilai total fee dari confins'
		String textTotalFeeAmt = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/label_TotalFee')).replace(
			'.00', '')
		
		'ambil nilai total premi to customer dari confins'
		String textTotalPremitoCust = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/label_TotalPremiumtoCustomer')).replace(
			',', '')
		
		'get perhitungan total fee dari excel'
		totalFeeResult = findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofColm, 87).replace(',', '')
	...
	textDiscountAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Discount_TotalCustDiscAmt'),
		'value').replace(',', '')
		
	'get capitalize amount from confins'
	String textCapitalizeAmount = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Capitalize Amount_insCpltzAmt'),
			'value').replace(',', '')
			
	if(GlobalVariable.Role=="Testing"){
		'Ambil nilai total premi to customer after discount dari confins'
		String textTotalPremitoCustAftDisc = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/label_TotalPremiumtoCustomerAfterDiscount')).replace(
			',', '')
...
//Jika cap insurance setting bernilai partial
	...
	WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerPersonal/NAP2 - Application Data/CF4W/TabInsuranceDataMultifinancePartialCapitalize'),
...
def checkDDL(Sql sqlConnectionFOU){
	if(GlobalVariable.Role=="Testing"){
		...
		if(WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_InscoBranchNameMF'),
			inscoBranchName)==false){
			
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('8.TabInsuranceData', GlobalVariable.NumofColm, GlobalVariable.StatusFailed, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofColm, 2) + ';'+GlobalVariable.ReasonFailedDDL)
			
			GlobalVariable.FlagFailed=1
		}
		
		'Ambil nilai jumlah option/pilihan insco branch name dari confins'
		Integer totalInscoBranch = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_InscoBranchNameMF'))
		...
		int totalddlcoverperiod = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_CoverPeriodMF'))
		...
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_CoverPeriodMF'),
			coverperiod) == false) {
		...
		int totalddlpaymenttype = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_Payment Type MF'))
		
		'verify total ddl paymenttype confins = total ddl db'
		WebUI.verifyEqual(totalddlpaymenttype - 1, paymenttype.size())
				
		'verify isi ddl coverperiod confins = db'
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_Payment Type MF'),
				paymenttype) == false) {
...
public inputInsInfo(Sql sqlConnectionLOS,Sql sqlConnectionFOU, String appNo){
		...
		if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
			...
			if(WebUI.verifyMatch(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_AssetRegionMF'),'value'),defaultAssetReg, false)==false){
				writeFailedReasonVerifyRule()
			}
		...
		WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_AssetRegionMF'),
			findTestData(excelPathTabInsurance).getValue(
				GlobalVariable.NumofColm, 22), false)
		
		'Input Coverage Amount'
		WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Coverage Amount MF'),
			findTestData(excelPathTabInsurance).getValue(
		...
		WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_CoverPeriodMF'),
			coverPeriod, false)
		...
		if ((coverPeriod == 'Over Tenor') || (coverPeriod == 'Partial Tenor')) {
			...
			WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Insurance Length MF'),
				findTestData(excelPathTabInsurance).getValue(
					GlobalVariable.NumofColm, 28))
		}
		
		'Select option dropdownlist payment type'
		WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/select_Payment Type MF'),
			findTestData(excelPathTabInsurance).getValue(
