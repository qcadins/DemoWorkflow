...
if (GlobalVariable.Role == 'Testing') {
    ...
    String POName = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_ProductOfferingCF4W'))
    ...
    String textInterest = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeCF4W'), 
        'value')

	'get text Product Offering'
	product = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/POName'))
	...
	int totalddlappsource = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_ApplicationSourceCF4W'))
	...
	int totalddlInstType = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_FirstInstallmentTypeCF4W'))
	...
	int totalddlPayFreq = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_PaymentFrequencyCF4W'))
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_ApplicationSourceCF4W'),
		appsource) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_FirstInstallmentTypeCF4W'),
			InstType) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_PaymentFrequencyCF4W'),
			PayFreq) == false) {
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_ApplicationSourceCF4W'), 
    findTestData(excelPathTabApplication).getValue(
        GlobalVariable.NumofColm, 17), false, FailureHandling.OPTIONAL)

'Select option dropdownlist First Installment Type'
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_FirstInstallmentTypeCF4W'), 
    findTestData(excelPathTabApplication).getValue(
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_PaymentFrequencyCF4W'), 
    payFreq, false)
...
'Input tenor'
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_TenorCF4W'), 
    tenorString)
...
if (GlobalVariable.Role == 'Testing') {
    ...
    WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_NumOfInstallmentCF4W'))

    'Verify numofinstallment sesuai perhitungan'
    WebUI.verifyElementText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_NumOfInstallmentCF4W'), 
...
String textInterestType = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeCF4W'), 
    'value', FailureHandling.OPTIONAL)

//'Select option dropdownlist Interest Type'
//WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeCF4W'), 
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_BlackListAppiCF4W'), 
    findTestData(excelPathTabApplication).getValue(
        GlobalVariable.NumofColm, 56), false)

'Input APPI Score'
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_APPI SCORECF4W'), 
    findTestData(excelPathTabApplication).getValue(
...
if (WebUI.verifyMatch(WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/ApplicationCurrentStep')), 
	...
	if(GlobalVariable.Role == 'Testing' && GlobalVariable.CheckVerifStoreDBPersonal=="Yes"){
			...
			WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerPersonal/NAP2 - Application Data/CF4W/TabApplicationDataStoreDBVerif'),
