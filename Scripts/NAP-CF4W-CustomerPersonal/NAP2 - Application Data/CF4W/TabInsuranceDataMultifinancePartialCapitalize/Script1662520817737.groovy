...
for (int i = 1; i <= count; i++) {
	...
	yearNumObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/td_YearNo'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[2]",true)
	...
	//Main Premi Rate
	mainPremiRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[7]/div/input",true)
	...
	for (int j = 1; j <= countAddCov; j++) {
		...
		if(flagLoad==0){
			...
			modifyAddtRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_AddtRate'),'xpath','equals',"//div[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr["+(j+2)+"]/td[7]/div/span/div/input",true)
...
if(findTestData(excelPathTabInsurance).getValue(
	...
	if(WebUI.verifyElementNotChecked(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'), GlobalVariable.TimeOut,FailureHandling.OPTIONAL)){
		'Centang full capitalize amount'
		WebUI.check(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'))
	}
}
	...
	if(WebUI.verifyElementChecked(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'), GlobalVariable.TimeOut,FailureHandling.OPTIONAL)){
		'Uncentang full capitalize amounts'
		WebUI.uncheck(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'))
	}
}
...
if(WebUI.verifyElementNotChecked(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'), GlobalVariable.TimeOut,FailureHandling.OPTIONAL)&&findTestData(excelPathTabInsurance).getValue(
				GlobalVariable.NumofColm, capPartialRow+2).length()>0){
	'Input capitalize amount'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Capitalize Amount_insCpltzAmt'),findTestData(excelPathTabInsurance).getValue(
...
if(GlobalVariable.Role=="Testing"){
	...
	totalFeeResult = findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofColm, 87)
...
if(GlobalVariable.Role=="Testing"){
	...
	textCapitalizeAmount = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Capitalize Amount_insCpltzAmt'),
		'value').replace(',', '')
	...
	// Verif untuk capitalizze bukan 0 dan tidak ada paid by mf
		...
		WebUI.doubleClick(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'))
	...
	else if((totalResult[3]) == 0 && totalResult[2]==1 && WebUI.verifyElementChecked(findTestObject('NAP-CF4W-CustomerCompany/NAP2-ApplicationData/TabInsuranceData/CF4W/input_FullCapitalizedAmount'), GlobalVariable.TimeOut,FailureHandling.OPTIONAL)){
		'Verify capitalize amount sesuai perhitungan'
		checkVerifyEqualOrMatch(WebUI.verifyMatch(textCapitalizeAmount, (totalResult[3]+Long.parseLong(totalFeeResult.replace(',',''))).toString(),false))
	}
}
...
public AddRatetoGV(int count, int countAddCov){
	...
	for (int i = 1; i <= count; i++) {
		...
		numOfMonthObj = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[3]",true)
		
		'get numofmonth from confins'
		Integer numofmonth = Integer.parseInt(WebUI.getText(numOfMonthObj))
		
		//Main Premi Rate
		mainPremiRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[7]/div/input",true)
		...
		for (int j = 1; j <= countAddCov; j++) {
			...
			modifyAddtRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/CF4W/input_AddtRate'),'xpath','equals',"//div[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr["+(j+2)+"]/td[7]/div/span/div/input",true)
