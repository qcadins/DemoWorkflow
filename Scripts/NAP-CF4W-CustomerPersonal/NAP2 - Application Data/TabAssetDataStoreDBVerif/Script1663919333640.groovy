...
ArrayList<String> resultsupplierinformation = CustomKeywords.'dbConnection.CustomerDataVerif.NAP2TabAssetSupplierInfoStoreDB'(
    sqlconnection, datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 13))
...
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 12).toUpperCase(), (resultsupplierinformation[
        arraysuppinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify supplier name'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 13).toUpperCase(), (resultsupplierinformation[
        arraysuppinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify sales person'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 14).toUpperCase(), (resultsupplierinformation[
        arraysuppinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify admin head'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 15).toUpperCase(), (resultsupplierinformation[
        arraysuppinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify asset code'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 17).toUpperCase(), (resultassetinformation[
        arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify asset condition'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 18).toUpperCase(), (resultassetinformation[
        arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify asset price'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 19).replace(',', ''), resultassetinformation[
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 26).equalsIgnoreCase('Percentage')) {
    'verify DP percent'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 27).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'skip amount'
    arrayassetinfoindex++
} else if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 26).equalsIgnoreCase('Amount')) {
    'skip percentage'
    arrayassetinfoindex++

    'verify DP Amount'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 28).replace(',', ''), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))
}

'verify chasis number'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 29).toUpperCase(), (resultassetinformation[
        arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

'verify engine number'
arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 30).toUpperCase(), (resultassetinformation[
        arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 37).equalsIgnoreCase('No')) {
    'verify user name'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 38).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 41).equalsIgnoreCase('No')) {
    'verify owner type'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 42).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify owner name'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 43).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify owner relation'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 44).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))
    ...
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 48).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))
...
if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 52).equalsIgnoreCase('Yes')) {
    'verify address'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 38).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify Rt'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 39).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify RW'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 40).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify Zipcode'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 41).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify kecamatan'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 42).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify kelurahan'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 43).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify kota'
    arrayMatch.add(WebUI.verifyMatch(datafileCustomerPersonal.getValue(GlobalVariable.NumofColm, 44).toUpperCase(), (resultassetinformation[
            arrayassetinfoindex++]).toUpperCase(), false, FailureHandling.OPTIONAL))
} else {
    'verify address'
...
for (int i = 0; i < resultdocumentinformation.size(); i) {
    if (datafileTabAsset.getValue(GlobalVariable.NumofColm, 64).length() > 0) {
        'verify received'
        arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 64).toUpperCase(), (resultdocumentinformation[
    ...
    'verify document no'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 65).toUpperCase(), (resultdocumentinformation[
            i++]).toUpperCase(), false, FailureHandling.OPTIONAL))

    'verify expired date'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 66), resultdocumentinformation[
            i++], false, FailureHandling.OPTIONAL))

    'verify document notes'
    arrayMatch.add(WebUI.verifyMatch(datafileTabAsset.getValue(GlobalVariable.NumofColm, 67).toUpperCase(), (resultdocumentinformation[
            i++]).toUpperCase(), false, FailureHandling.OPTIONAL))
}
