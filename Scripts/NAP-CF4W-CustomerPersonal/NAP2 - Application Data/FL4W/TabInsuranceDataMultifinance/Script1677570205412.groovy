...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_InscoBranchNameMF'),
	findTestData(excelPathTabInsurance).getValue(
		GlobalVariable.NumofInsurance, 26), false)

insuranceNotesCompany = findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/textarea_Insurance Notes MF')

if (findTestData(excelPathTabInsurance).getValue(
	GlobalVariable.NumofInsurance, 12) == 'Customer - Multifinance') {
...
WebUI.setText(insuranceNotesCompany, findTestData(excelPathTabInsurance).getValue(
		GlobalVariable.NumofInsurance, 27))

buttonGenerateInsurance = findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/button_Generate Insurance')
if (findTestData(excelPathTabInsurance).getValue(
	GlobalVariable.NumofInsurance, 12) == 'Customer - Multifinance') {
...
GlobalVariable.InsuranceLength = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/insurancelength'),
...
if (WebUI.verifyTextNotPresent('INSURANCE FEE', false, FailureHandling.OPTIONAL)) {
	'click cancel'
	WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/button_Cancel'))

	GlobalVariable.IsDataCancel = 1
	
	'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.StatusReasonGenerateGagal'
	CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('8.TabInsuranceData', GlobalVariable.NumofInsurance, GlobalVariable.StatusFailed, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofInsurance, 2) + ';'+GlobalVariable.StatusReasonGenerateGagal)
...
if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
	...
	adminFeeDefAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Admin Fee_adminFee'),'value')
	
	'Ambil nilai customer stamp duty dari confins'
	custStampDutyDefAmt = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Customer Stampduty Fee_adminFee'),'value')
	...
	if(feeBhv[0]=="DEF"){
		...
		if(WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Admin Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
	}
		...
		if(WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Admin Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
		else{
			...
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelNumber'(GlobalVariable.DataFilePath, '8.TabInsuranceData', 30,
				GlobalVariable.NumofInsurance - 1, Integer.parseInt(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Admin Fee_adminFee'),'value').replace(",","")))
		}
	}
	if(feeBhv[1]=="DEF"){
		'Verif field customer stampduty bisa diedit'
		if(WebUI.verifyElementNotHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Customer Stampduty Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
	}
		...
		if(WebUI.verifyElementHasAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Customer Stampduty Fee_adminFee'),"readonly", GlobalVariable.TimeOut,FailureHandling.OPTIONAL)==false){
			'write to excel failed reason verify rule'
			writeFailedReasonVerifyRule()
		}
		else{
			...
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelNumber'(GlobalVariable.DataFilePath, '8.TabInsuranceData', 31,
				GlobalVariable.NumofInsurance - 1, Integer.parseInt(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Customer Stampduty Fee_adminFee'),'value').replace(",","")))
		}
	}
}
...
if (findTestData(excelPathTabInsurance).getValue(
	GlobalVariable.NumofInsurance, 30) == 'NO') {
	'Input Admin Fee'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Admin Fee_adminFee'),
		findTestData(excelPathTabInsurance).getValue(
			GlobalVariable.NumofInsurance, 31), FailureHandling.OPTIONAL)

	'Input Customer Stampduty Fee'
	WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Customer Stampduty Fee_adminFee'),
		findTestData(excelPathTabInsurance).getValue(
			GlobalVariable.NumofInsurance, 32), FailureHandling.OPTIONAL)
}
...
if(GlobalVariable.Role == 'Testing'){
	...
	ArrayList<String> maincvg = CustomKeywords.'insuranceData.checkInsRateBase.checkMainCVGDDL'(sqlConnectionFOU)
			...
			int totalddlmaincvg = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_MainCoverage'))
			...
			if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_MainCoverage'),
					maincvg) == false) {
				
				'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
				CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('8.TabInsuranceData', GlobalVariable.NumofInsurance, GlobalVariable.StatusFailed, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofInsurance, 2) + ';'+GlobalVariable.ReasonFailedDDL + 'maincvg')
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_MainCoverage'),
	findTestData(excelPathTabInsurance).getValue(
		GlobalVariable.NumofInsurance, 34), false)
...
for (int i = 1; i <= countAddCov; i++) {
	...
	modifyCheckboxAddtCov = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Flood_checkboxLabel ng-valid'),
	...
	String checkboxValue = findTestData(excelPathTabInsurance).getValue(
		GlobalVariable.NumofInsurance, (addCovRow + i) - countEmpty)
...
'Klik apply to all'
WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/button_Apply To All'))
...
if(capinssetting=="YEARLY"){
	...
	String rwd = CustomKeywords.'assetData.checkAssetRoadWorthinessDoc.checkRWDFL4W'(sqlConnectionLOS,appNo, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofInsurance, 7))
	
	'Looping data tabel insurance untuk input data'
	for (int i = 1; i <= count; i++) {
		//modify object year num
		yearNumObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/td_YearNo'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[3]",true)
		if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
		...
		//Capitalize
		capitalizeObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Capitalized'),
		...
		capitalizeValue = findTestData(excelPathTabInsurance).getValue(
			GlobalVariable.NumofInsurance, editGenTableRow+1)
		...
		//Main Premi Rate
		mainPremiRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[8]/div/input",true)
		...
		for (int j = 1; j <= countAddCov; j++) {
			...
			if(flagLoad==0){
				...
				modifyAddtRateObject = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_AddtRate'),'xpath','equals',"//div[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr["+(j+2)+"]/td[8]/div/span/div/input",true)
	...
	for (int i = 1; i <= count; i++) {
		...
		numOfMonthObj = WebUI.modifyObjectProperty(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Rate'),'xpath','equals',"//*[@id='insuranceCoverage']/div[5]/table/tbody["+i+"]/tr[1]/td[4]",true)
	...
	if(GlobalVariable.Role=="Testing"){
		...
		totalFeeResult = findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofInsurance, 87).replace(',', '')
	...
	String textCapitalizeAmount = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Capitalize Amount_insCpltzAmt'),
			'value').replace(',', '')
	...
	CustomKeywords.'customizeKeyword.writeExcel.writeToExcel'(GlobalVariable.DataFilePath, '8.TabInsuranceData', TotalPremium+4,
...
//Jika cap insurance setting bernilai partial
	...
	WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerPersonal/NAP2 - Application Data/FL4W/TabInsuranceDataMultifinancePartialCapitalize'),
...
CustomKeywords.'customizeKeyword.writeExcel.writeToExcelNumber'(GlobalVariable.DataFilePath, '8.TabInsuranceData', capPartialRow+1,
	GlobalVariable.NumofInsurance - 1, cptlzAmount)
...
def checkDDL(Sql sqlConnectionFOU){
	if(GlobalVariable.Role=="Testing"){
		...
		String officeName = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/label_officename'))
		...
		if(WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_InscoBranchNameMF'),
			inscoBranchName)==false){
			
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('8.TabInsuranceData', GlobalVariable.NumofInsurance, GlobalVariable.StatusFailed, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofInsurance, 2) + ';'+GlobalVariable.ReasonFailedDDL)
			
			GlobalVariable.FlagFailed=1
		}
		
		'Ambil nilai jumlah option/pilihan insco branch name dari confins'
		Integer totalInscoBranch = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_InscoBranchNameMF'))
		...
		int totalddlcoverperiod = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_CoverPeriodMF'))
		...
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_CoverPeriodMF'),
			coverperiod) == false) {
	
			'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.ReasonFailedDDL'
			CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('8.TabInsuranceData', GlobalVariable.NumofInsurance, GlobalVariable.StatusFailed, findTestData(excelPathTabInsurance).getValue(GlobalVariable.NumofInsurance, 2) + ';'+GlobalVariable.ReasonFailedDDL + 'cover period')
		...
		int totalddlpaymenttype = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_Payment Type MF'))
		
		'verify total ddl paymenttype confins = total ddl db'
		WebUI.verifyEqual(totalddlpaymenttype - 1, paymenttype.size())
				
		'verify isi ddl coverperiod confins = db'
		if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_Payment Type MF'),
				paymenttype) == false) {
...
public inputInsInfo(Sql sqlConnectionLOS,Sql sqlConnectionFOU, String appNo){
		...
		if(GlobalVariable.Role=="Testing" && GlobalVariable.CheckRulePersonal=="Yes" && GlobalVariable.FirstTimeEntry == "Yes"){
			...
			if(WebUI.verifyMatch(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_AssetRegionMF'),'value'),defaultAssetReg, false)==false){
				writeFailedReasonVerifyRule()
			}
		...
		WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_AssetRegionMF'),
			findTestData(excelPathTabInsurance).getValue(
				GlobalVariable.NumofInsurance, 22), false)
		
		'Input Coverage Amount'
		WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Coverage Amount MF'),
			findTestData(excelPathTabInsurance).getValue(
				GlobalVariable.NumofInsurance, 23))
		
		'get coverperiod from excel'
		coverPeriod = findTestData(excelPathTabInsurance).getValue(
			GlobalVariable.NumofInsurance, 24)
		
		'Select option dropdownlist cover period'
		WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_CoverPeriodMF'),
			coverPeriod, false)
		...
		if ((coverPeriod == 'Over Tenor') || (coverPeriod == 'Partial Tenor')) {
			...
			WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/input_Insurance Length MF'),
				findTestData(excelPathTabInsurance).getValue(
					GlobalVariable.NumofInsurance, 28))
		}
		
		'Select option dropdownlist payment type'
		WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabInsuranceData/FL4W/select_Payment Type MF'),
			findTestData(excelPathTabInsurance).getValue(
				GlobalVariable.NumofInsurance, 25), false)
}