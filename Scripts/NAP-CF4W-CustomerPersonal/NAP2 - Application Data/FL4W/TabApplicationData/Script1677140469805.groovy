...
//    String textInterest = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeFL4W'), 
//        'value')
	String textInterest = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeFL4W'))
	...
	int totalddlappsource = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_ApplicationSourceFL4W'))
	
	'get total label from ddl installment scheme'
	int totalddlinstallmentscheme = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InstallmentScheme'))
	
	'get total label from ddl wop'
	int totalddlwop = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_WayOfPayment'))
	
	'get total label from ddl InstType'
	int totalddlInstType = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_FirstInstallmentTypeFL4W'))
	
	'get total label from ddl COC'
	int totalddlCOC = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_CharacteristicOfCredit'))
	
	'get total label from ddl PayFreq'
	int totalddlPayFreq = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_PaymentFrequencyFL4W'))
	
	'get total label from ddl DPSrcPayType'
	int totalddlDPSrcPayType = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_DPSourcePaymentType'))
	
	'get total label from ddl InstSrcPayType'
	int totalddlInstSrcPayType = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InstallmentSourcePaymentType'))
	
	'get total label from ddl CustNotif'
	int totalddlCustNotif = WebUI.getNumberOfTotalOption(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_CustomerNotification'))
	...
	WebUI.verifyEqual(totalddlCustNotif - 1, CustNotif.size())

	'verify isi ddl app source confins = db'
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_ApplicationSourceFL4W'),
		appsource) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InstallmentScheme'),
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_WayOfPayment'),
			wop) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_FirstInstallmentTypeFL4W'),
			InstType) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_CharacteristicOfCredit'),
			COC) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_PaymentFrequencyFL4W'),
			PayFreq) == false) {
	...
	if (WebUI.verifyOptionsPresent(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_CustomerNotification'),
			CustNotif) == false) {
...
//		String[] userLogin = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_userLogin')).replace(
//			' ', '').replace('|', ';').split(';')
//		
//		String usernameLogin = userLogin[0]
//		
//		'Ambil text label officer dari confins'
//		String textOfficer = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_Officer'))
//
...
//		String textSPV = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_SPV'))
//
...
//			String[] textTotalDataOfficer = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_TotalDataOfficer')).replace(
//				' ', '').replace(':', ';').split(';')
//
...
//
//		'Input MO Head Name'
//		WebUI.setText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_MO Head Name'),
//			findTestData(excelPathTabApplication).getValue(
...
//				spvName = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/span_SPVLookup'))
//
...
//				String textSPV = WebUI.getText(findTestObject('Object Repository/NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_LookupSPV'))
//
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_ApplicationSourceFL4W'),
	findTestData(excelPathTabApplication).getValue(
		GlobalVariable.NumofColm, 17), false, FailureHandling.OPTIONAL)

'Select option dropdownlist First Installment Type'
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_FirstInstallmentTypeFL4W'),
	findTestData(excelPathTabApplication).getValue(
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_PaymentFrequencyFL4W'),
	payFreq, false)
...
'Input tenor'
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_TenorFL4W'),
	tenorString)
...
if (GlobalVariable.Role == 'Testing') {
	...
	WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_NumOfInstallmentFL4W'))

	'Verify numofinstallment sesuai perhitungan'
	WebUI.verifyElementText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/label_NumOfInstallmentFL4W'),
...
if (findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 21).length() > 0) {
	...
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/MOU Customer'),
		findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 21), false)
}

if (findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 22).length() > 0) {
	'Select option dropdownlist DPSourcePaymentType'
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_DPSourcePaymentType'),
		findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 22), false)
}

//String textInterestType = WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeFL4W'),
//	'value', FailureHandling.OPTIONAL)
String textInterestType = WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeFL4W'))

//'Select option dropdownlist Interest Type'
//WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_InterestTypeFL4W'),
...
textwop = findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 26)
...
if (textwop == 'Auto Debit') {
    ...
    WebUI.selectOptionByIndex(bankacc, findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 27))
...
if (findTestData(excelPathTabApplication).getValue(
	GlobalVariable.NumofColm, 29).length() > 0) {
	...
	WebUI.selectOptionByLabel(inssource, findTestData(excelPathTabApplication).getValue(
			GlobalVariable.NumofColm, 29), false)
}

//Cross App/Agr
def appCross = findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 62)
def agrCross = findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 63)
def custCross = findTestData(excelPathTabApplication).getValue(GlobalVariable.NumofColm, 64)
...
if (findTestData(excelPathTabApplication).getValue(
	...
	WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_CopyAddressFrom'),
		findTestData(excelPathTabApplication).getValue(
			GlobalVariable.NumofColm, 31), false)
...
WebUI.selectOptionByLabel(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/select_BlackListAppiFL4W'),
	findTestData(excelPathTabApplication).getValue(
		GlobalVariable.NumofColm, 57), false)

'Input APPI Score'
WebUI.setText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_APPI SCOREFL4W'),
	findTestData(excelPathTabApplication).getValue(
		GlobalVariable.NumofColm, 58))

'Click Lookup REF MASTER APP DATA'
WebUI.click(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/button_ATTRIBUTE MASTER CODE'))
...
if (GlobalVariable.FlagFailed == 0) {
	...
	CustomKeywords.'checkSaveProcess.checkSaveProcess.checkStatus'(iscompleteMandatory, findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabAssetData/button_Asset Name_FL4W'),
...
if (WebUI.verifyMatch(WebUI.getText(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/ApplicationCurrentStep')),
	...
	if(GlobalVariable.Role == 'Testing' && GlobalVariable.CheckVerifStoreDBCompany=="Yes"){
			...
			WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerPersonal/NAP2 - Application Data/FL4W/TabApplicationDataStoreDBVerif'),
...
def getAddress(){
	...
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/textarea_Address'),
			'value'))

	'add RT to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_RT'),
			'value'))

	'add RW to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_RW'),
			'value'))

	'add zipcode to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/labelZipcode'), 'value'))
	
	'add kelurahan to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/labelKelurahan'),
			'value'))

	'add kecamatan to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/labelKecamatan'),
			'value'))

	'add kota to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/labelKota'),
			'value'))
	
	'add Phone 1 Area to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 1 area'),
			'value'))
	
	'add Phone 1 number to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 1 number'),
			'value'))
	
	'add Phone 1 extension to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 1 extension'),
			'value'))
	
	'add Phone 2 Area to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 2 area'),
			'value'))
	
	'add Phone 2 number to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 2 number'),
			'value'))
	
	'add Phone 2 extension to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 2 extension'),
			'value'))
	
	'add Phone 3 Area to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 3 area'),
			'value'))
	
	'add Phone 3 number to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 3 number'),
			'value'))
	
	'add Phone 3 extension to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_Phone 3 extension'),
			'value'))
	
	'add Phone fax area to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_fax area'),
			'value'))
	
	'add Phone fax number to array'
	confinsdata.add(WebUI.getAttribute(findTestObject('NAP-CF4W-CustomerPersonal/NAP2-ApplicationData/TabApplicationData/input_fax number'),
			'value'))
