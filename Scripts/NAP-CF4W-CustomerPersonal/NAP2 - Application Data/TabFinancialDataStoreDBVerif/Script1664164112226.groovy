...
ArrayList<String> resultFee = CustomKeywords.'dbConnection.CustomerDataVerif.NAP2FinancialFeeStoreDB'(sqlconnection, findTestData(excelPathCustomerPersonal).getValue(GlobalVariable.NumofColm, 
        13))
