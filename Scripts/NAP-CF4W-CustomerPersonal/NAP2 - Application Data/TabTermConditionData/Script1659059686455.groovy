...
if(!appLastStep.equalsIgnoreCase("FINANCIAL DATA") && !appLastStep.equalsIgnoreCase("TERM AND CONDITION") && GlobalVariable.FirstTimeEntry=="Yes"){
...
'declare TCCode, TCMandatory, TCPrior, TCWaive'
...
if (GlobalVariable.Role == 'Testing' && GlobalVariable.CheckVerifStoreDBPersonal=="Yes") {
	...
	WebUI.callTestCase(findTestCase('NAP-CF4W-CustomerPersonal/NAP2 - Application Data/TabTCDataStoreDBVerif'),
...
public checkVerifyEqualOrMatch(Boolean isMatch){
	if(isMatch==false && GlobalVariable.FlagFailed==0){
		...
		CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('11.TabTermConditionData', GlobalVariable.NumofColm, GlobalVariable.StatusFailed, GlobalVariable.ReasonFailedVerifyEqualOrMatch)
