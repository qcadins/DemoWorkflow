...
if ((GlobalVariable.Role == 'Testing') && (GlobalVariable.findTestDataCustomerPersonal.getValue(GlobalVariable.NumofColm, 
    ...
    listGuar = CustomKeywords.'dbConnection.getInfoForEditNAP.getGuarantorDataforEditNAP'(sqlConnectionLOS, GlobalVariable.findTestDataCustomerPersonal.getValue(GlobalVariable.NumofColm, 
            8))
            ...
            if (WebUI.verifyElementPresent(modifyNewGuarantorName, 5, FailureHandling.OPTIONAL)) {
                if (WebUI.getText(modifyNewGuarantorTypeName).equalsIgnoreCase('Personal')) {
                    if (WebUI.getText(modifyNewGuarantorName).equalsIgnoreCase(GlobalVariable.findTestDataGuarantorPersonal.getValue(
                        ...
                        if ((GlobalVariable.Role == 'Testing') && (GlobalVariable.findTestDataGuarantorPersonal.getValue(
                        ...
                        if (GlobalVariable.findTestDataGuarantorPersonal.getValue(GlobalVariable.NumofGuarantorPersonal + 
                            1, 12) != GlobalVariable.findTestDataCustomerPersonal.getValue(GlobalVariable.NumofColm, 13)) {
