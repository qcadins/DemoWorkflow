...
ArrayList<String> resultCustomerMainData = CustomKeywords.'dbconnection.VerifyAppView.checkCustomerMainDataPersonal'(sqlconnection, 
    appno)
...
ArrayList<String> resultFindata = CustomKeywords.'dbconnection.VerifyAppView.checkFinancialDataPersonal'(sqlconnection, 
    appno)
...
if ((GlobalVariable.FlagWarning == 0) && (GlobalVariable.FlagFailed == 0)) {
	new customizeKeyword.writeToExcel().writeToExcelFunction(GlobalVariable.DataFilePath, '2. Customer', 0, GlobalVariable.NumofColm -
...
def checkVerifyEqualOrMatch(Boolean isMatch) {
    if ((isMatch == false) && (GlobalVariable.FlagFailed == 0)) {
        ...
        new customizeKeyword.writeToExcel().writeToExcelFunction(GlobalVariable.DataFilePath, '2. Customer', 1, GlobalVariable.NumofColm - 
