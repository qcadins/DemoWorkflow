...
WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/button_Profession Name_btn btn-raised btn-primary'))

'input kode profesi'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Profession Code_professionCodeId'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 42))

'click button search'
WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/button_Search'))

'verify input error'
verifyInputError()

'pilih job position'
WebUI.selectOptionByLabel(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/select_JobPosition'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 44), false)

if (WebUI.verifyElementNotChecked(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Is Well Known Company_ng-untouched ng-pristine ng-valid'), 
    GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
    'check is well known company'
    if (findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 45) == 'Yes') {
        WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Is Well Known Company_ng-untouched ng-pristine ng-valid'))
    }
} else if (WebUI.verifyElementChecked(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Is Well Known Company_ng-untouched ng-pristine ng-valid'), 
    GlobalVariable.TimeOut)) {
    'check is well known company'
    if (findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 45) == 'No') {
        WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Is Well Known Company_ng-untouched ng-pristine ng-valid'))
    }
}

'input nama perusahaan'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Company Name'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 46))

'click button lookup industry type'
WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/button_Industry Type_btn'))

'input industry code'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Industry Type Code'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 47))
...
if (findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 49).length() > 0) {
    'pilih big/medium/small'
    WebUI.selectOptionByLabel(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/select_--Select One-- Big  Medium  Small'), 
        findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 49), false)
}

'input start working date'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Start Working Date_form-control ng-untouched ng-pristine ng-valid'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 50))

'input job title'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Job Title Name_form-control ng-untouched ng-pristine ng-valid'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 51))

'input number of employee'
WebUI.setText(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/input_Number of Employee_form-control ng-untouched ng-pristine ng-valid'), 
    findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 52))

if (findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 53).length() > 0) {
    'select investment type'
    WebUI.selectOptionByLabel(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/select_--Select One-- Domestic Investment  Foreign Investment'), 
        findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 53), false)
}
...
WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/button_Save  Continue'))
...
def verifyInputError(){
	if (WebUI.verifyElementPresent(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/a_Select'),
		GlobalVariable.TimeOut, FailureHandling.OPTIONAL)) {
		'click select'
		WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/a_Select'))
	} else {
		'click X'
		WebUI.click(findTestObject('NAP/NAP4-CustomerDataCompletion/CustomerPersonal/JobDataSME/button_X'))
	
		'Write To Excel GlobalVariable.StatusFailed and GlobalVariable.StatusReasonLookup'
		CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('3.JobData', GlobalVariable.ColmNAP4, GlobalVariable.StatusFailed, findTestData(GlobalVariable.excelPath).getValue(GlobalVariable.ColmNAP4, 2) + ';' +GlobalVariable.StatusReasonLookup)
