...
if (copyapp.equalsIgnoreCase('Edit')) {
	...
	if (assettypefaileddelete.size() > 0) {
		...
		CustomKeywords.'customizeKeyword.writeExcel.writeToExcelStatusReason'('6.CustomerAsset', Address, GlobalVariable.StatusWarning, GlobalVariable.ReasonFailedDelete + assettypefaileddelete)
