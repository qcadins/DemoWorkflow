...
public class verifyAddtCvg {
	...
	public checkAddtCvgCode(Sql instanceLOS, String addtName){
		...
		instanceLOS.eachRow(("select MASTER_CODE from FOUNDATION.dbo.REF_MASTER where REF_MASTER_TYPE_CODE = 'INS_ADD_CVG_TYPE' and is_active=1 and DESCR = '"+addtName+"'"), { def row ->
			refcode = row[0]
		})
