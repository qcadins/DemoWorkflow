...
public class verifyPaging {
	...
	public resetPagingAppInquiry(){
		...
		WebUI.setText(findTestObject('Object Repository/AppView/input_appDate'),"AppDate")
		WebUI.setText(findTestObject('Object Repository/AppView/input_appDateKurangDari'),"AppDateLessThan")
